#line 1 "../Core/Src/stm32f1xx_hal_timebase_tim.c"
...
#line 22 "../Core/Src/stm32f1xx_hal_timebase_tim.c"
#line 23 "../Core/Src/stm32f1xx_hal_timebase_tim.c"
...
HAL_StatusTypeDef HAL_InitTick(uint32_t TickPriority)
{
  ...
  do { volatile uint32_t tmpreg; ((((RCC_TypeDef *)((0x40000000UL + 0x00020000UL) + 0x00001000UL))->APB1ENR) |= ((0x1UL << (2U)))); tmpreg = ((((RCC_TypeDef *)((0x40000000UL + 0x00020000UL) + 0x00001000UL))->APB1ENR) & ((0x1UL << (2U)))); (void)tmpreg; } while(0U);
  ...
  htim4.Instance = ((TIM_TypeDef *)(0x40000000UL + 0x00000800UL));
  ...
  htim4.Init.AutoReloadPreload = 0x00000000U;
