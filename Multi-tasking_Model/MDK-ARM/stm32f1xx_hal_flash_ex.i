...
#line 42 "../Drivers/STM32F1xx_HAL_Driver/Src/stm32f1xx_hal_flash_ex.c"
...
HAL_StatusTypeDef HAL_FLASHEx_Erase(FLASH_EraseInitTypeDef *pEraseInit, uint32_t *PageError)
{
  ...
  if (pEraseInit->TypeErase == 0x02U)
  {
#line 211 "../Drivers/STM32F1xx_HAL_Driver/Src/stm32f1xx_hal_flash_ex.c"
    {
...
#line 268 "../Drivers/STM32F1xx_HAL_Driver/Src/stm32f1xx_hal_flash_ex.c"
   {
      ...
      if (FLASH_WaitForLastOperation((uint32_t)50000U) == HAL_OK)
      {
        ...
        *PageError = 0xFFFFFFFFU;
        ...
        for(address = pEraseInit->PageAddress;
            address < ((pEraseInit->NbPages * 0x400U) + pEraseInit->PageAddress);
            address += 0x400U)
        {
...
HAL_StatusTypeDef HAL_FLASHEx_OBErase(void)
{
  ...
  if(status == HAL_OK)
  {
    ...
    ((((FLASH_TypeDef *)((0x40000000UL + 0x00020000UL) + 0x00002000UL))->CR) |= ((0x1UL << (5U))));
    ((((FLASH_TypeDef *)((0x40000000UL + 0x00020000UL) + 0x00002000UL))->CR) |= ((0x1UL << (6U))));
...
HAL_StatusTypeDef HAL_FLASHEx_OBProgram(FLASH_OBProgramInitTypeDef *pOBInit)
{
  ...
  if((pOBInit->OptionType & 0x01U) == 0x01U)
  {
    ((void)0U);
    if (pOBInit->WRPState == 0x01U)
    {
  ...
  if((pOBInit->OptionType & 0x02U) == 0x02U)
  {
  ...
  if((pOBInit->OptionType & 0x04U) == 0x04U)
  {
  ...
  if((pOBInit->OptionType & 0x08U) == 0x08U)
  {
...
void HAL_FLASHEx_OBGetConfig(FLASH_OBProgramInitTypeDef *pOBInit)
{
  pOBInit->OptionType = 0x01U | 0x02U | 0x04U;
...
uint32_t HAL_FLASHEx_OBGetUserData(uint32_t DATAAdress)
{
  ...
  if (DATAAdress == 0x1FFFF804U)
  {
     
    value = ((((FLASH_TypeDef *)((0x40000000UL + 0x00020000UL) + 0x00002000UL))->OBR) & ((0xFFUL << (10U)))) >> (10U);
  }
  else
  {
     
    value = ((((FLASH_TypeDef *)((0x40000000UL + 0x00020000UL) + 0x00002000UL))->OBR) & ((0xFFUL << (18U)))) >> (18U);
  }
...
#line 620 "../Drivers/STM32F1xx_HAL_Driver/Src/stm32f1xx_hal_flash_ex.c"
...
static HAL_StatusTypeDef FLASH_OB_EnableWRP(uint32_t WriteProtectPage)
{
  ...
  WRP0_Data = (uint16_t)(WriteProtectPage & 0x000000FFU);

  



  WRP1_Data = (uint16_t)((WriteProtectPage & 0x0000FF00U) >> 8U);

 

  WRP2_Data = (uint16_t)((WriteProtectPage & 0x00FF0000U) >> 16U);
  ...
  WRP3_Data = (uint16_t)((WriteProtectPage & 0xFF000000U) >> 24U); 
#line 690 "../Drivers/STM32F1xx_HAL_Driver/Src/stm32f1xx_hal_flash_ex.c"
  ...
  { 
    ...
    if (status == HAL_OK)  
    {
      ...
      ((((FLASH_TypeDef *)((0x40000000UL + 0x00020000UL) + 0x00002000UL))->CR) |= ((0x1UL << (4U))));


      if(WRP0_Data != 0xFFU)
      {
        ((OB_TypeDef *)0x1FFFF800UL)->WRP0 &= WRP0_Data;
      ...
      {
        ((OB_TypeDef *)0x1FFFF800UL)->WRP1 &= WRP1_Data;
      ...
      {
        ((OB_TypeDef *)0x1FFFF800UL)->WRP2 &= WRP2_Data;
      ...
      {
        ((OB_TypeDef *)0x1FFFF800UL)->WRP3 &= WRP3_Data;
...
static HAL_StatusTypeDef FLASH_OB_DisableWRP(uint32_t WriteProtectPage)
{
  ...
  WRP3_Data = (uint16_t)((WriteProtectPage & 0xFF000000U) >> 24U); 
#line 813 "../Drivers/STM32F1xx_HAL_Driver/Src/stm32f1xx_hal_flash_ex.c"
...
static HAL_StatusTypeDef FLASH_OB_RDP_LevelConfig(uint8_t ReadProtectLevel)
{
  ...
  { 
    ...
    if(status == HAL_OK)
    {
      ...
      ((((OB_TypeDef *)0x1FFFF800UL)->RDP) = (ReadProtectLevel));
...
static HAL_StatusTypeDef FLASH_OB_UserConfig(uint8_t UserConfig)
{
  ...
  {     
    ...
    ((OB_TypeDef *)0x1FFFF800UL)->USER = (UserConfig | 0x88U);
...
static uint32_t FLASH_OB_GetWRP(void)
{
  ...
  return (uint32_t)(((((FLASH_TypeDef *)((0x40000000UL + 0x00020000UL) + 0x00002000UL))->WRPR)));
}
...
static uint32_t FLASH_OB_GetRDP(void)
{
  uint32_t readstatus = ((uint8_t)0xA5);
  uint32_t tmp_reg = 0U;
  
   
  tmp_reg = ((((FLASH_TypeDef *)((0x40000000UL + 0x00020000UL) + 0x00002000UL))->OBR) & ((0x1UL << (1U))));

  if (tmp_reg == (0x1UL << (1U)))
  {
    readstatus = ((uint8_t)0x00);
  }
  else 
  {
    readstatus = ((uint8_t)0xA5);
  }
...
static uint8_t FLASH_OB_GetUser(void)
{
  ...
  return (uint8_t)((((((FLASH_TypeDef *)((0x40000000UL + 0x00020000UL) + 0x00002000UL))->OBR)) & (0x7UL << (2U))) >> (2U));
}
...
#line 1103 "../Drivers/STM32F1xx_HAL_Driver/Src/stm32f1xx_hal_flash_ex.c"
     
    ((((FLASH_TypeDef *)((0x40000000UL + 0x00020000UL) + 0x00002000UL))->CR) |= ((0x1UL << (1U))));
    ((((FLASH_TypeDef *)((0x40000000UL + 0x00020000UL) + 0x00002000UL))->AR) = (PageAddress));
    ((((FLASH_TypeDef *)((0x40000000UL + 0x00020000UL) + 0x00002000UL))->CR) |= ((0x1UL << (6U))));
