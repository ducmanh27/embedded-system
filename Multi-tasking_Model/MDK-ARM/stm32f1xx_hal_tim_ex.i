...
#line 82 "../Drivers/STM32F1xx_HAL_Driver/Src/stm32f1xx_hal_tim_ex.c"
...
#line 174 "../Drivers/STM32F1xx_HAL_Driver/Src/stm32f1xx_hal_tim_ex.c"
...
#line 258 "../Drivers/STM32F1xx_HAL_Driver/Src/stm32f1xx_hal_tim_ex.c"
...
HAL_StatusTypeDef HAL_TIMEx_OCN_Stop_IT(TIM_HandleTypeDef *htim, uint32_t Channel)
{
  ...
  if (status == HAL_OK)
  {
    ...
    if ((tmpccer & ((0x1UL << (2U)) | (0x1UL << (6U)) | (0x1UL << (10U)))) == (uint32_t)RESET)
    {
      ((htim)->Instance ->DIER &= ~((0x1UL << (7U))));
    }
