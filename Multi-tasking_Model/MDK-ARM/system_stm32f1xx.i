...
#line 263 "../Drivers/CMSIS/Device/ST/STM32F1xx/Include/stm32f1xx.h"
...
#line 59 "../Core/Src/system_stm32f1xx.c"
...
#line 114 "../Core/Src/system_stm32f1xx.c"
  ...
  switch (tmp)
  {
    ...
    case 0x08U:   
      ...
      else
      {
        ...
        if ((((RCC_TypeDef *)((0x40000000UL + 0x00020000UL) + 0x00001000UL))->CFGR & (0x1UL << (17U))) != (uint32_t)RESET)
        { 
          SystemCoreClock = (8000000U >> 1U) * pllmull;
        }
        else
...
#line 318 "../Core/Src/system_stm32f1xx.c"
      break;
  ...
  tmp = AHBPrescTable[((((RCC_TypeDef *)((0x40000000UL + 0x00020000UL) + 0x00001000UL))->CFGR & (0xFUL << (4U))) >> 4U)];
   
  SystemCoreClock >>= tmp;  
}

#line 395 "../Core/Src/system_stm32f1xx.c"
