...
#line 41 "../Drivers/STM32F1xx_HAL_Driver/Src/stm32f1xx_hal_gpio_ex.c"
...
void HAL_GPIOEx_ConfigEventout(uint32_t GPIO_PortSource, uint32_t GPIO_PinSource)
{
  ...
  (((((AFIO_TypeDef *)((0x40000000UL + 0x00010000UL) + 0x00000000UL))->EVCR)) = ((((((((AFIO_TypeDef *)((0x40000000UL + 0x00010000UL) + 0x00000000UL))->EVCR))) & (~(((0x7UL << (4U))) | ((0xFUL << (0U)))))) | ((GPIO_PortSource) | (GPIO_PinSource)))));
}
...
void HAL_GPIOEx_EnableEventout(void)
{
  ((((AFIO_TypeDef *)((0x40000000UL + 0x00010000UL) + 0x00000000UL))->EVCR) |= ((0x1UL << (7U))));
}
