...
#line 137 "../Middlewares/Third_Party/FreeRTOS/Source/CMSIS_RTOS_V2/cmsis_os.h"

#line 145 "../Middlewares/Third_Party/FreeRTOS/Source/CMSIS_RTOS_V2/cmsis_os.h"
...
#line 147 "../Middlewares/Third_Party/FreeRTOS/Source/CMSIS_RTOS_V2/cmsis_os.h"
...
#line 148 "../Middlewares/Third_Party/FreeRTOS/Source/CMSIS_RTOS_V2/cmsis_os.h"
...
#line 173 "../Middlewares/Third_Party/FreeRTOS/Source/CMSIS_RTOS_V2/cmsis_os.h"
...
#line 189 "../Middlewares/Third_Party/FreeRTOS/Source/CMSIS_RTOS_V2/cmsis_os.h"





#line 213 "../Middlewares/Third_Party/FreeRTOS/Source/CMSIS_RTOS_V2/cmsis_os.h"
typedef int32_t                  osStatus;
#line 224 "../Middlewares/Third_Party/FreeRTOS/Source/CMSIS_RTOS_V2/cmsis_os.h"
...
#line 275 "../Middlewares/Third_Party/FreeRTOS/Source/CMSIS_RTOS_V2/cmsis_os.h"
...
#line 301 "../Middlewares/Third_Party/FreeRTOS/Source/CMSIS_RTOS_V2/cmsis_os.h"


#line 310 "../Middlewares/Third_Party/FreeRTOS/Source/CMSIS_RTOS_V2/cmsis_os.h"


#line 319 "../Middlewares/Third_Party/FreeRTOS/Source/CMSIS_RTOS_V2/cmsis_os.h"
...
#line 333 "../Middlewares/Third_Party/FreeRTOS/Source/CMSIS_RTOS_V2/cmsis_os.h"
...
#line 347 "../Middlewares/Third_Party/FreeRTOS/Source/CMSIS_RTOS_V2/cmsis_os.h"
...
#line 443 "../Middlewares/Third_Party/FreeRTOS/Source/CMSIS_RTOS_V2/cmsis_os.h"
...
#line 528 "../Middlewares/Third_Party/FreeRTOS/Source/CMSIS_RTOS_V2/cmsis_os.h"
...
#line 544 "../Middlewares/Third_Party/FreeRTOS/Source/CMSIS_RTOS_V2/cmsis_os.h"
...
#line 593 "../Middlewares/Third_Party/FreeRTOS/Source/CMSIS_RTOS_V2/cmsis_os.h"
...
#line 644 "../Middlewares/Third_Party/FreeRTOS/Source/CMSIS_RTOS_V2/cmsis_os.h"
...
#line 723 "../Middlewares/Third_Party/FreeRTOS/Source/CMSIS_RTOS_V2/cmsis_os.h"
...
#line 745 "../Middlewares/Third_Party/FreeRTOS/Source/CMSIS_RTOS_V2/cmsis_os.h"
...
#line 832 "../Middlewares/Third_Party/FreeRTOS/Source/CMSIS_RTOS_V2/cmsis_os.h"





#line 25 "../Core/Src/main.c"
...
#line 33 "../Core/Src/main.c"
#line 1 "../Lib/i2c-lcd.h"

#line 3 "../Lib/i2c-lcd.h"
...
#line 34 "../Core/Src/main.c"
#line 1 "../Lib/mpu6050.h"
...
#line 14 "../Lib/mpu6050.h"
#line 15 "../Lib/mpu6050.h"
...
#line 36 "../Core/Src/main.c"
#line 1 "../Lib/setScheduler.h"
#line 4 "../Lib/setScheduler.h"
#line 17 "../Lib/setScheduler.h"
void setScheduler(char **argv, uint8_t arg_num);
void WRITE_FLASH(uint32_t address, int value);
#line 37 "../Core/Src/main.c"
...
void SendDataOverUART(char *data) {
  ...
  if (osMutexAcquire(UARTMutexHandle, 0xFFFFFFFFU) == osOK) {
    ...
    for (uint16_t i = 0; i < length; i++) {
      ...
      while (!(((USART_TypeDef *)(0x40000000UL + 0x00004400UL))->SR & (0x1UL << (7U))));

      
      ((USART_TypeDef *)(0x40000000UL + 0x00004400UL))->DR = (uint8_t)data[i];
    }

    
    while (!(((USART_TypeDef *)(0x40000000UL + 0x00004400UL))->SR & (0x1UL << (6U))));
...
int main(void)
{
  ...
  MX_TIM3_Init();
	...
	flag_update =  Flash_Read_Int( (0X800FFFE));
	
	if (flag_update != 0x0000FFFF)
	{
		D1 =  Flash_Read_Int( (0X800FC00));
		D2 =  Flash_Read_Int( (0X800FC02));
		D3 =  Flash_Read_Int( (0X800FC04));
		D4 =  Flash_Read_Int( (0X800FC06));

		Ph1 = Flash_Read_Int( (0X800FC08));
		Ph2 = Flash_Read_Int( (0X800FC0A));
		Ph3 = Flash_Read_Int( (0X800FC0C));
		Ph4 = Flash_Read_Int( (0X800FC0E));
		
		
		T1 = Flash_Read_Int( (0X800FC10));
		T2 = Flash_Read_Int( (0X800FC12));
		T3 = Flash_Read_Int( (0X800FC14));
		T4 = Flash_Read_Int( (0X800FC16));
	}

	
	HAL_TIM_PWM_Start(&htim3,0x00000000U);
	HAL_TIM_PWM_Start(&htim3,0x00000004U);
	HAL_TIM_PWM_Start(&htim3,0x00000008U);
  ...
  Read_Sensor_MPUHandle = osThreadNew(Read_Sensor_MPUTask_func, 0, &Read_Sensor_MPU_attributes);

   
  Read_Sensor_SHTHandle = osThreadNew(Read_Sensor_SHT21Task_func, 0, &Read_Sensor_SHT_attributes);

   
  Show_LCD1602Handle = osThreadNew(Show_LCD1602_Task_func, 0, &Show_LCD1602_attributes);

   
  Send_UARTHandle = osThreadNew(Send_UART_Task_func, 0, &Send_UART_attributes);
...
void SystemClock_Config(void)
{
  ...
  RCC_OscInitStruct.HSEPredivValue = 0x00000000U;
  RCC_OscInitStruct.HSIState = (0x1UL << (0U));
  RCC_OscInitStruct.PLL.PLLState = 0x00000002U;
  RCC_OscInitStruct.PLL.PLLSource = (0x1UL << (16U));
  RCC_OscInitStruct.PLL.PLLMUL = (0x7UL << (18U));
  ...
  RCC_ClkInitStruct.APB2CLKDivider = 0x00000500U;

  if (HAL_RCC_ClockConfig(&RCC_ClkInitStruct, (0x2UL << (0U))) != HAL_OK)
  {
    Error_Handler();
  }
}
...
void MX_TIM3_Init(void)
{
  ...
  ((RCC_TypeDef *)((0x40000000UL + 0x00020000UL) + 0x00001000UL))->APB1ENR |= (0x1UL << (1U));
  ...
  htim3.Instance = ((TIM_TypeDef *)(0x40000000UL + 0x00000400UL));
  ...
  ((TIM_TypeDef *)(0x40000000UL + 0x00000400UL))->PSC = 0x00001F3F; 
  ((TIM_TypeDef *)(0x40000000UL + 0x00000400UL))->ARR = 0x00000063; 

  
  ((TIM_TypeDef *)(0x40000000UL + 0x00000400UL))->CCMR1 = 0x00006868;
  ((TIM_TypeDef *)(0x40000000UL + 0x00000400UL))->CCMR2 = 0x00006868;

  
  ((TIM_TypeDef *)(0x40000000UL + 0x00000400UL))->CR1 = 0;
  ((TIM_TypeDef *)(0x40000000UL + 0x00000400UL))->CR2 = 0;
  ((TIM_TypeDef *)(0x40000000UL + 0x00000400UL))->SMCR = 0;
  ((TIM_TypeDef *)(0x40000000UL + 0x00000400UL))->DIER = 0;
  ((TIM_TypeDef *)(0x40000000UL + 0x00000400UL))->EGR = 0;
  ((TIM_TypeDef *)(0x40000000UL + 0x00000400UL))->CCER = 0;
  ((TIM_TypeDef *)(0x40000000UL + 0x00000400UL))->CNT = 0;
  ((TIM_TypeDef *)(0x40000000UL + 0x00000400UL))->CCR1 = 0;
  ((TIM_TypeDef *)(0x40000000UL + 0x00000400UL))->CCR2 = 0;
  ((TIM_TypeDef *)(0x40000000UL + 0x00000400UL))->CCR3 = 0;
  ((TIM_TypeDef *)(0x40000000UL + 0x00000400UL))->CCR4 = 0;
  ((TIM_TypeDef *)(0x40000000UL + 0x00000400UL))->DCR = 0;
  ((TIM_TypeDef *)(0x40000000UL + 0x00000400UL))->DMAR = 0;
...
static void MX_USART2_UART_Init(void)
{
  ...
  huart2.Init.Mode = ((uint32_t)((0x1UL << (3U)) | (0x1UL << (2U))));
...
static void MX_GPIO_Init(void)
{
  ...
  do { volatile uint32_t tmpreg; ((((RCC_TypeDef *)((0x40000000UL + 0x00020000UL) + 0x00001000UL))->APB2ENR) |= ((0x1UL << (5U)))); tmpreg = ((((RCC_TypeDef *)((0x40000000UL + 0x00020000UL) + 0x00001000UL))->APB2ENR) & ((0x1UL << (5U)))); (void)tmpreg; } while(0U);
  ...
  do { volatile uint32_t tmpreg; ((((RCC_TypeDef *)((0x40000000UL + 0x00020000UL) + 0x00001000UL))->APB2ENR) |= ((0x1UL << (3U)))); tmpreg = ((((RCC_TypeDef *)((0x40000000UL + 0x00020000UL) + 0x00001000UL))->APB2ENR) & ((0x1UL << (3U)))); (void)tmpreg; } while(0U);

   
  HAL_GPIO_WritePin(((GPIO_TypeDef *)((0x40000000UL + 0x00010000UL) + 0x00000C00UL)), ((uint16_t)0x0010), GPIO_PIN_SET);

   
  HAL_GPIO_WritePin(((GPIO_TypeDef *)((0x40000000UL + 0x00010000UL) + 0x00000C00UL)), ((uint16_t)0x0020), GPIO_PIN_RESET);

   
  GPIO_InitStruct.Pin = ((uint16_t)0x0010)|((uint16_t)0x0020);
  GPIO_InitStruct.Mode = 0x00000001u;
  GPIO_InitStruct.Pull = 0x00000000u;
  GPIO_InitStruct.Speed = ((0x2UL << (0U)));
  HAL_GPIO_Init(((GPIO_TypeDef *)((0x40000000UL + 0x00010000UL) + 0x00000C00UL)), &GPIO_InitStruct);
...
void Send_UART_Task_func(void *argument)
{
  ...
  for(;;)
  {
		...
		if (osSemaphoreAcquire(BinarySem_UART_1Handle, 0xFFFFFFFFU) == osOK
    && osSemaphoreAcquire(BinarySem_UART_2Handle, 0xFFFFFFFFU) == osOK
    && osSemaphoreAcquire(BinarySem_UART_3Handle, 0xFFFFFFFFU) == osOK)
		{
...
void HAL_TIM_PeriodElapsedCallback(TIM_HandleTypeDef *htim)
{
  ...
  if (htim->Instance == ((TIM_TypeDef *)(0x40000000UL + 0x00000800UL))) {
    HAL_IncTick();
  }
