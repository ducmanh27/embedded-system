...
#line 87 "../Drivers/STM32F1xx_HAL_Driver/Src/stm32f1xx_hal_exti.c"
...
HAL_StatusTypeDef HAL_EXTI_SetConfigLine(EXTI_HandleTypeDef *hexti, EXTI_ConfigTypeDef *pExtiConfig)
{
  ...
  linepos = (pExtiConfig->Line & 0x0000001Fu);
  ...
  if ((pExtiConfig->Line & (0x02uL << 24u)) != 0x00u)
  {
    ...
    {
      ((EXTI_TypeDef *)((0x40000000UL + 0x00010000UL) + 0x00000400UL))->RTSR |= maskline;
    }
    else
    {
      ((EXTI_TypeDef *)((0x40000000UL + 0x00010000UL) + 0x00000400UL))->RTSR &= ~maskline;
    ...
    {
      ((EXTI_TypeDef *)((0x40000000UL + 0x00010000UL) + 0x00000400UL))->FTSR |= maskline;
    }
    else
    {
      ((EXTI_TypeDef *)((0x40000000UL + 0x00010000UL) + 0x00000400UL))->FTSR &= ~maskline;
    ...
    if ((pExtiConfig->Line & ((0x04uL << 24u) | (0x02uL << 24u))) == ((0x04uL << 24u) | (0x02uL << 24u)))
    {
      ...
      regval = ((AFIO_TypeDef *)((0x40000000UL + 0x00010000UL) + 0x00000000UL))->EXTICR[linepos >> 2u];
      regval &= ~((0xFUL << (0U)) << ((4U) * (linepos & 0x03u)));
      regval |= (pExtiConfig->GPIOSel << ((4U) * (linepos & 0x03u)));
      ((AFIO_TypeDef *)((0x40000000UL + 0x00010000UL) + 0x00000000UL))->EXTICR[linepos >> 2u] = regval;
    }
  }
  ...
  {
    ((EXTI_TypeDef *)((0x40000000UL + 0x00010000UL) + 0x00000400UL))->IMR |= maskline;
  }
  else
  {
    ((EXTI_TypeDef *)((0x40000000UL + 0x00010000UL) + 0x00000400UL))->IMR &= ~maskline;
  ...
  {
    ((EXTI_TypeDef *)((0x40000000UL + 0x00010000UL) + 0x00000400UL))->EMR |= maskline;
  }
  else
  {
    ((EXTI_TypeDef *)((0x40000000UL + 0x00010000UL) + 0x00000400UL))->EMR &= ~maskline;
...
HAL_StatusTypeDef HAL_EXTI_GetConfigLine(EXTI_HandleTypeDef *hexti, EXTI_ConfigTypeDef *pExtiConfig)
{
  ...
  if ((((EXTI_TypeDef *)((0x40000000UL + 0x00010000UL) + 0x00000400UL))->IMR & maskline) != 0x00u)
  {
  ...
  if ((((EXTI_TypeDef *)((0x40000000UL + 0x00010000UL) + 0x00000400UL))->EMR & maskline) != 0x00u)
  {
  ...
  if ((pExtiConfig->Line & (0x02uL << 24u)) != 0x00u)
  {
    ...
    if ((((EXTI_TypeDef *)((0x40000000UL + 0x00010000UL) + 0x00000400UL))->RTSR & maskline) != 0x00u)
    {
    ...
    if ((((EXTI_TypeDef *)((0x40000000UL + 0x00010000UL) + 0x00000400UL))->FTSR & maskline) != 0x00u)
    {
...
HAL_StatusTypeDef HAL_EXTI_ClearConfigLine(EXTI_HandleTypeDef *hexti)
{
  ...
  linepos = (hexti->Line & 0x0000001Fu);
  maskline = (1uL << linepos);

   
  ((EXTI_TypeDef *)((0x40000000UL + 0x00010000UL) + 0x00000400UL))->IMR = (((EXTI_TypeDef *)((0x40000000UL + 0x00010000UL) + 0x00000400UL))->IMR & ~maskline);

   
  ((EXTI_TypeDef *)((0x40000000UL + 0x00010000UL) + 0x00000400UL))->EMR = (((EXTI_TypeDef *)((0x40000000UL + 0x00010000UL) + 0x00000400UL))->EMR & ~maskline);

   
  if ((hexti->Line & (0x02uL << 24u)) != 0x00u)
  {
    ((EXTI_TypeDef *)((0x40000000UL + 0x00010000UL) + 0x00000400UL))->RTSR = (((EXTI_TypeDef *)((0x40000000UL + 0x00010000UL) + 0x00000400UL))->RTSR & ~maskline);
    ((EXTI_TypeDef *)((0x40000000UL + 0x00010000UL) + 0x00000400UL))->FTSR = (((EXTI_TypeDef *)((0x40000000UL + 0x00010000UL) + 0x00000400UL))->FTSR & ~maskline);
...
void HAL_EXTI_IRQHandler(EXTI_HandleTypeDef *hexti)
{
  ...
  maskline = (1uL << (hexti->Line & 0x0000001Fu));

   
  regval = (((EXTI_TypeDef *)((0x40000000UL + 0x00010000UL) + 0x00000400UL))->PR & maskline);
  if (regval != 0x00u)
  {
     
    ((EXTI_TypeDef *)((0x40000000UL + 0x00010000UL) + 0x00000400UL))->PR = maskline;
...
uint32_t HAL_EXTI_GetPending(EXTI_HandleTypeDef *hexti, uint32_t Edge)
{
  ...
  regval = ((((EXTI_TypeDef *)((0x40000000UL + 0x00010000UL) + 0x00000400UL))->PR & maskline) >> linepos);
  return regval;
}
...
void HAL_EXTI_GenerateSWI(EXTI_HandleTypeDef *hexti)
{
  ...
  ((EXTI_TypeDef *)((0x40000000UL + 0x00010000UL) + 0x00000400UL))->SWIER = maskline;
}
