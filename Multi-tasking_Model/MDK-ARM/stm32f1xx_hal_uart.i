...
#line 259 "../Drivers/STM32F1xx_HAL_Driver/Src/stm32f1xx_hal_uart.c"
...
#line 394 "../Drivers/STM32F1xx_HAL_Driver/Src/stm32f1xx_hal_uart.c"
...
#line 463 "../Drivers/STM32F1xx_HAL_Driver/Src/stm32f1xx_hal_uart.c"
...
#line 542 "../Drivers/STM32F1xx_HAL_Driver/Src/stm32f1xx_hal_uart.c"
...
#line 627 "../Drivers/STM32F1xx_HAL_Driver/Src/stm32f1xx_hal_uart.c"
  ...
  ((huart->Instance ->CR2) &= ~((0xFUL << (0U))));
  ((huart->Instance ->CR2) |= (Address));

   
  ((huart->Instance ->CR1) &= ~((0x1UL << (11U))));
...
#line 696 "../Drivers/STM32F1xx_HAL_Driver/Src/stm32f1xx_hal_uart.c"
...
#line 1041 "../Drivers/STM32F1xx_HAL_Driver/Src/stm32f1xx_hal_uart.c"
...
HAL_StatusTypeDef HAL_UART_Transmit(UART_HandleTypeDef *huart, const uint8_t *pData, uint16_t Size, uint32_t Timeout)
{
  ...
  if (huart->gState == HAL_UART_STATE_READY)
  {
    ...
    if ((huart->Init.WordLength == ((uint32_t)(0x1UL << (12U)))) && (huart->Init.Parity == 0x00000000U))
    {
      pdata8bits  = 0;
    ...
    {
      if (UART_WaitOnFlagUntilTimeout(huart, ((uint32_t)(0x1UL << (7U))), RESET, tickstart, Timeout) != HAL_OK)
      {
        return HAL_TIMEOUT;
      }
      if (pdata8bits == 0)
    ...
    if (UART_WaitOnFlagUntilTimeout(huart, ((uint32_t)(0x1UL << (6U))), RESET, tickstart, Timeout) != HAL_OK)
    {
      return HAL_TIMEOUT;
    }
...
HAL_StatusTypeDef HAL_UART_Receive(UART_HandleTypeDef *huart, uint8_t *pData, uint16_t Size, uint32_t Timeout)
{
  ...
  if (huart->RxState == HAL_UART_STATE_READY)
  {
    ...
    {
      if (UART_WaitOnFlagUntilTimeout(huart, ((uint32_t)(0x1UL << (5U))), RESET, tickstart, Timeout) != HAL_OK)
      {
        return HAL_TIMEOUT;
      }
      if (pdata8bits == 0)
      ...
      {
        if ((huart->Init.WordLength == ((uint32_t)(0x1UL << (12U)))) || ((huart->Init.WordLength == 0x00000000U) && (huart->Init.Parity == 0x00000000U)))
        {
...
HAL_StatusTypeDef HAL_UART_Transmit_IT(UART_HandleTypeDef *huart, const uint8_t *pData, uint16_t Size)
{
  ...
  if (huart->gState == HAL_UART_STATE_READY)
  {
    ...
    ((((((uint32_t)(1U << 28U | (0x1UL << (7U))))) >> 28U) == 1U)? ((huart)->Instance ->CR1 |= ((((uint32_t)(1U << 28U | (0x1UL << (7U))))) & 0x0000FFFFU)): (((((uint32_t)(1U << 28U | (0x1UL << (7U))))) >> 28U) == 2U)? ((huart)->Instance ->CR2 |= ((((uint32_t)(1U << 28U | (0x1UL << (7U))))) & 0x0000FFFFU)): ((huart)->Instance ->CR3 |= ((((uint32_t)(1U << 28U | (0x1UL << (7U))))) & 0x0000FFFFU)));
...
HAL_StatusTypeDef HAL_UART_Transmit_DMA(UART_HandleTypeDef *huart, const uint8_t *pData, uint16_t Size)
{
  ...
  if (huart->gState == HAL_UART_STATE_READY)
  {
    ...
    ((huart)->Instance ->SR = ~(((uint32_t)(0x1UL << (6U)))));

    
 
    do { uint32_t val; do { val = _Pragma("push") _Pragma("diag_suppress 3731") ((uint32_t ) __ldrex((volatile uint32_t *)&(huart->Instance ->CR3))) _Pragma("pop") | ((0x1UL << (7U))); } while ((_Pragma("push") _Pragma("diag_suppress 3731") __strex(val, (volatile uint32_t *)&(huart->Instance ->CR3)) _Pragma("pop")) != 0U); } while(0);
...
HAL_StatusTypeDef HAL_UART_DMAPause(UART_HandleTypeDef *huart)
{
  ...
  dmarequest = (((huart->Instance ->CR3) & ((0x1UL << (7U)))) != 0U);
  ...
  dmarequest = (((huart->Instance ->CR3) & ((0x1UL << (6U)))) != 0U);
  if ((huart->RxState == HAL_UART_STATE_BUSY_RX) && dmarequest)
  {
     
    do { uint32_t val; do { val = _Pragma("push") _Pragma("diag_suppress 3731") ((uint32_t ) __ldrex((volatile uint32_t *)&(huart->Instance ->CR1))) _Pragma("pop") & ~((0x1UL << (8U))); } while ((_Pragma("push") _Pragma("diag_suppress 3731") __strex(val, (volatile uint32_t *)&(huart->Instance ->CR1)) _Pragma("pop")) != 0U); } while(0);
    do { uint32_t val; do { val = _Pragma("push") _Pragma("diag_suppress 3731") ((uint32_t ) __ldrex((volatile uint32_t *)&(huart->Instance ->CR3))) _Pragma("pop") & ~((0x1UL << (0U))); } while ((_Pragma("push") _Pragma("diag_suppress 3731") __strex(val, (volatile uint32_t *)&(huart->Instance ->CR3)) _Pragma("pop")) != 0U); } while(0);

     
    do { uint32_t val; do { val = _Pragma("push") _Pragma("diag_suppress 3731") ((uint32_t ) __ldrex((volatile uint32_t *)&(huart->Instance ->CR3))) _Pragma("pop") & ~((0x1UL << (6U))); } while ((_Pragma("push") _Pragma("diag_suppress 3731") __strex(val, (volatile uint32_t *)&(huart->Instance ->CR3)) _Pragma("pop")) != 0U); } while(0);
  }
...
HAL_StatusTypeDef HAL_UART_DMAResume(UART_HandleTypeDef *huart)
{
  ...
  if (huart->RxState == HAL_UART_STATE_BUSY_RX)
  {
    ...
    do{ volatile uint32_t tmpreg = 0x00U; tmpreg = (huart)->Instance ->SR; tmpreg = (huart)->Instance ->DR; (void)tmpreg; } while(0U);
  ...
  if (huart->RxState == HAL_UART_STATE_READY)
  {
    ...
    *RxLen = 0U;
    ...
    while (huart->RxXferCount > 0U)
    {
      ...
      if ((((huart)->Instance ->SR & (((uint32_t)(0x1UL << (4U))))) == (((uint32_t)(0x1UL << (4U))))))
      {
      ...
      if ((((huart)->Instance ->SR & (((uint32_t)(0x1UL << (5U))))) == (((uint32_t)(0x1UL << (5U))))))
      {
        if (pdata8bits == 0)
        {
...
HAL_StatusTypeDef HAL_UART_Abort(UART_HandleTypeDef *huart)
{
  ...
  do { uint32_t val; do { val = _Pragma("push") _Pragma("diag_suppress 3731") ((uint32_t ) __ldrex((volatile uint32_t *)&(huart->Instance ->CR1))) _Pragma("pop") & ~(((0x1UL << (5U)) | (0x1UL << (8U)) | (0x1UL << (7U)) | (0x1UL << (6U)))); } while ((_Pragma("push") _Pragma("diag_suppress 3731") __strex(val, (volatile uint32_t *)&(huart->Instance ->CR1)) _Pragma("pop")) != 0U); } while(0);
  do { uint32_t val; do { val = _Pragma("push") _Pragma("diag_suppress 3731") ((uint32_t ) __ldrex((volatile uint32_t *)&(huart->Instance ->CR3))) _Pragma("pop") & ~((0x1UL << (0U))); } while ((_Pragma("push") _Pragma("diag_suppress 3731") __strex(val, (volatile uint32_t *)&(huart->Instance ->CR3)) _Pragma("pop")) != 0U); } while(0);
  ...
  if ((((huart->Instance ->CR3) & ((0x1UL << (7U)))) != 0U))
  {
    do { uint32_t val; do { val = _Pragma("push") _Pragma("diag_suppress 3731") ((uint32_t ) __ldrex((volatile uint32_t *)&(huart->Instance ->CR3))) _Pragma("pop") & ~((0x1UL << (7U))); } while ((_Pragma("push") _Pragma("diag_suppress 3731") __strex(val, (volatile uint32_t *)&(huart->Instance ->CR3)) _Pragma("pop")) != 0U); } while(0);
  ...
  if ((((huart->Instance ->CR3) & ((0x1UL << (6U)))) != 0U))
  {
    do { uint32_t val; do { val = _Pragma("push") _Pragma("diag_suppress 3731") ((uint32_t ) __ldrex((volatile uint32_t *)&(huart->Instance ->CR3))) _Pragma("pop") & ~((0x1UL << (6U))); } while ((_Pragma("push") _Pragma("diag_suppress 3731") __strex(val, (volatile uint32_t *)&(huart->Instance ->CR3)) _Pragma("pop")) != 0U); } while(0);
...
HAL_StatusTypeDef HAL_UART_AbortTransmit(UART_HandleTypeDef *huart)
{
  ...
  do { uint32_t val; do { val = _Pragma("push") _Pragma("diag_suppress 3731") ((uint32_t ) __ldrex((volatile uint32_t *)&(huart->Instance ->CR1))) _Pragma("pop") & ~(((0x1UL << (7U)) | (0x1UL << (6U)))); } while ((_Pragma("push") _Pragma("diag_suppress 3731") __strex(val, (volatile uint32_t *)&(huart->Instance ->CR1)) _Pragma("pop")) != 0U); } while(0);
...
HAL_StatusTypeDef HAL_UART_AbortReceive(UART_HandleTypeDef *huart)
{
  ...
  do { uint32_t val; do { val = _Pragma("push") _Pragma("diag_suppress 3731") ((uint32_t ) __ldrex((volatile uint32_t *)&(huart->Instance ->CR1))) _Pragma("pop") & ~(((0x1UL << (5U)) | (0x1UL << (8U)))); } while ((_Pragma("push") _Pragma("diag_suppress 3731") __strex(val, (volatile uint32_t *)&(huart->Instance ->CR1)) _Pragma("pop")) != 0U); } while(0);
  do { uint32_t val; do { val = _Pragma("push") _Pragma("diag_suppress 3731") ((uint32_t ) __ldrex((volatile uint32_t *)&(huart->Instance ->CR3))) _Pragma("pop") & ~((0x1UL << (0U))); } while ((_Pragma("push") _Pragma("diag_suppress 3731") __strex(val, (volatile uint32_t *)&(huart->Instance ->CR3)) _Pragma("pop")) != 0U); } while(0);
...
void HAL_UART_IRQHandler(UART_HandleTypeDef *huart)
{
  ...
  if (errorflags == RESET)
  {
    ...
    if (((isrflags & (0x1UL << (5U))) != RESET) && ((cr1its & (0x1UL << (5U))) != RESET))
    {
  ...
  if ((errorflags != RESET) && (((cr3its & (0x1UL << (0U))) != RESET)
                                || ((cr1its & ((0x1UL << (5U)) | (0x1UL << (8U)))) != RESET)))
  {
     
    if (((isrflags & (0x1UL << (0U))) != RESET) && ((cr1its & (0x1UL << (8U))) != RESET))
    {
      huart->ErrorCode |= 0x00000001U;
    }

     
    if (((isrflags & (0x1UL << (2U))) != RESET) && ((cr3its & (0x1UL << (0U))) != RESET))
    {
      huart->ErrorCode |= 0x00000002U;
    }

     
    if (((isrflags & (0x1UL << (1U))) != RESET) && ((cr3its & (0x1UL << (0U))) != RESET))
    {
      huart->ErrorCode |= 0x00000004U;
    }

     
    if (((isrflags & (0x1UL << (3U))) != RESET) && (((cr1its & (0x1UL << (5U))) != RESET)
                                                 || ((cr3its & (0x1UL << (0U))) != RESET)))
    {
    ...
    if (huart->ErrorCode != 0x00000000U)
    {
      ...
      dmarequest = (((huart->Instance ->CR3) & ((0x1UL << (6U)))) != 0U);
      if (((huart->ErrorCode & 0x00000008U) != RESET) || dmarequest)
      {
      ...
      && ((cr1its & (0x1UL << (4U))) != 0U))
  {
    ...
    if ((((huart->Instance ->CR3) & ((0x1UL << (6U)))) != 0U))
    {
          ...
          && (nb_remaining_rx_data < huart->RxXferSize))
      {
        ...
        if (huart->hdmarx->Init.Mode != ((uint32_t)(0x1UL << (5U))))
        {
  ...
  if (((isrflags & (0x1UL << (7U))) != RESET) && ((cr1its & (0x1UL << (7U))) != RESET))
  {
  ...
  if (((isrflags & (0x1UL << (6U))) != RESET) && ((cr1its & (0x1UL << (6U))) != RESET))
  {
...
HAL_StatusTypeDef HAL_LIN_SendBreak(UART_HandleTypeDef *huart)
{
  ...
  do { uint32_t val; do { val = _Pragma("push") _Pragma("diag_suppress 3731") ((uint32_t ) __ldrex((volatile uint32_t *)&(huart->Instance ->CR1))) _Pragma("pop") | ((0x1UL << (0U))); } while ((_Pragma("push") _Pragma("diag_suppress 3731") __strex(val, (volatile uint32_t *)&(huart->Instance ->CR1)) _Pragma("pop")) != 0U); } while(0);
...
HAL_StatusTypeDef HAL_MultiProcessor_EnterMuteMode(UART_HandleTypeDef *huart)
{
  ...
  do { uint32_t val; do { val = _Pragma("push") _Pragma("diag_suppress 3731") ((uint32_t ) __ldrex((volatile uint32_t *)&(huart->Instance ->CR1))) _Pragma("pop") | ((0x1UL << (1U))); } while ((_Pragma("push") _Pragma("diag_suppress 3731") __strex(val, (volatile uint32_t *)&(huart->Instance ->CR1)) _Pragma("pop")) != 0U); } while(0);
...
HAL_StatusTypeDef HAL_HalfDuplex_EnableTransmitter(UART_HandleTypeDef *huart)
{
  ...
  tmpreg &= (uint32_t)~((uint32_t)((0x1UL << (3U)) | (0x1UL << (2U))));

   
  tmpreg |= (uint32_t)(0x1UL << (3U));
...
#line 2978 "../Drivers/STM32F1xx_HAL_Driver/Src/stm32f1xx_hal_uart.c"
...
static void UART_DMATransmitCplt(DMA_HandleTypeDef *hdma)
{
  ...
  if ((hdma->Instance->CCR & (0x1UL << (5U))) == 0U)
  {
    ...
    do { uint32_t val; do { val = _Pragma("push") _Pragma("diag_suppress 3731") ((uint32_t ) __ldrex((volatile uint32_t *)&(huart->Instance ->CR1))) _Pragma("pop") | ((0x1UL << (6U))); } while ((_Pragma("push") _Pragma("diag_suppress 3731") __strex(val, (volatile uint32_t *)&(huart->Instance ->CR1)) _Pragma("pop")) != 0U); } while(0);
  ...
  while (((((huart)->Instance ->SR & (Flag)) == (Flag)) ? SET : RESET) == Status)
  {
    ...
    if (Timeout != 0xFFFFFFFFU)
    {
      if ((Timeout == 0U) || ((HAL_GetTick() - Tickstart) > Timeout))
      {
        ...
        do { uint32_t val; do { val = _Pragma("push") _Pragma("diag_suppress 3731") ((uint32_t ) __ldrex((volatile uint32_t *)&(huart->Instance ->CR1))) _Pragma("pop") & ~(((0x1UL << (5U)) | (0x1UL << (8U)) | (0x1UL << (7U)))); } while ((_Pragma("push") _Pragma("diag_suppress 3731") __strex(val, (volatile uint32_t *)&(huart->Instance ->CR1)) _Pragma("pop")) != 0U); } while(0);
        do { uint32_t val; do { val = _Pragma("push") _Pragma("diag_suppress 3731") ((uint32_t ) __ldrex((volatile uint32_t *)&(huart->Instance ->CR3))) _Pragma("pop") & ~((0x1UL << (0U))); } while ((_Pragma("push") _Pragma("diag_suppress 3731") __strex(val, (volatile uint32_t *)&(huart->Instance ->CR3)) _Pragma("pop")) != 0U); } while(0);
...
HAL_StatusTypeDef UART_Start_Receive_IT(UART_HandleTypeDef *huart, uint8_t *pData, uint16_t Size)
{
  ...
  if (huart->Init.Parity != 0x00000000U)
  {
    ...
    ((((((uint32_t)(1U << 28U | (0x1UL << (8U))))) >> 28U) == 1U)? ((huart)->Instance ->CR1 |= ((((uint32_t)(1U << 28U | (0x1UL << (8U))))) & 0x0000FFFFU)): (((((uint32_t)(1U << 28U | (0x1UL << (8U))))) >> 28U) == 2U)? ((huart)->Instance ->CR2 |= ((((uint32_t)(1U << 28U | (0x1UL << (8U))))) & 0x0000FFFFU)): ((huart)->Instance ->CR3 |= ((((uint32_t)(1U << 28U | (0x1UL << (8U))))) & 0x0000FFFFU)));
  }

   
  ((((((uint32_t)(3U << 28U | (0x1UL << (0U))))) >> 28U) == 1U)? ((huart)->Instance ->CR1 |= ((((uint32_t)(3U << 28U | (0x1UL << (0U))))) & 0x0000FFFFU)): (((((uint32_t)(3U << 28U | (0x1UL << (0U))))) >> 28U) == 2U)? ((huart)->Instance ->CR2 |= ((((uint32_t)(3U << 28U | (0x1UL << (0U))))) & 0x0000FFFFU)): ((huart)->Instance ->CR3 |= ((((uint32_t)(3U << 28U | (0x1UL << (0U))))) & 0x0000FFFFU)));

   
  ((((((uint32_t)(1U << 28U | (0x1UL << (5U))))) >> 28U) == 1U)? ((huart)->Instance ->CR1 |= ((((uint32_t)(1U << 28U | (0x1UL << (5U))))) & 0x0000FFFFU)): (((((uint32_t)(1U << 28U | (0x1UL << (5U))))) >> 28U) == 2U)? ((huart)->Instance ->CR2 |= ((((uint32_t)(1U << 28U | (0x1UL << (5U))))) & 0x0000FFFFU)): ((huart)->Instance ->CR3 |= ((((uint32_t)(1U << 28U | (0x1UL << (5U))))) & 0x0000FFFFU)));
...
static HAL_StatusTypeDef UART_Transmit_IT(UART_HandleTypeDef *huart)
{
  ...
  if (huart->gState == HAL_UART_STATE_BUSY_TX)
  {
    ...
    if (--huart->TxXferCount == 0U)
    {
      ...
      ((((((uint32_t)(1U << 28U | (0x1UL << (6U))))) >> 28U) == 1U)? ((huart)->Instance ->CR1 |= ((((uint32_t)(1U << 28U | (0x1UL << (6U))))) & 0x0000FFFFU)): (((((uint32_t)(1U << 28U | (0x1UL << (6U))))) >> 28U) == 2U)? ((huart)->Instance ->CR2 |= ((((uint32_t)(1U << 28U | (0x1UL << (6U))))) & 0x0000FFFFU)): ((huart)->Instance ->CR3 |= ((((uint32_t)(1U << 28U | (0x1UL << (6U))))) & 0x0000FFFFU)));
    }
    return HAL_OK;
  }
  else
...
#line 3709 "../Drivers/STM32F1xx_HAL_Driver/Src/stm32f1xx_hal_uart.c"
  tmpreg = (uint32_t)huart->Init.WordLength | huart->Init.Parity | huart->Init.Mode;
  (((huart->Instance ->CR1)) = ((((((huart->Instance ->CR1))) & (~((uint32_t)((0x1UL << (12U)) | (0x1UL << (10U)) | (0x1UL << (9U)) | (0x1UL << (3U)) | (0x1UL << (2U)))))) | (tmpreg))));
  ...
  (((huart->Instance ->CR3)) = ((((((huart->Instance ->CR3))) & (~(((0x1UL << (8U)) | (0x1UL << (9U)))))) | (huart->Init . HwFlowCtl))));


  if(huart->Instance == ((USART_TypeDef *)((0x40000000UL + 0x00010000UL) + 0x00003800UL)))
  {
...
#line 3740 "../Drivers/STM32F1xx_HAL_Driver/Src/stm32f1xx_hal_uart.c"
  huart->Instance->BRR = (((((((((pclk)))*25U)/(4U*(((huart->Init . BaudRate)))))/100U) << 4U) + ((((((((((pclk)))*25U)/(4U*(((huart->Init . BaudRate))))) - ((((((((pclk))))*25U)/(4U*((((huart->Init . BaudRate))))))/100U) * 100U)) * 16U) + 50U) / 100U) & 0xF0U)) + ((((((((((pclk)))*25U)/(4U*(((huart->Init . BaudRate))))) - ((((((((pclk))))*25U)/(4U*((((huart->Init . BaudRate))))))/100U) * 100U)) * 16U) + 50U) / 100U) & 0x0FU));
