...
#line 27 "../Drivers/STM32F1xx_HAL_Driver/Src/stm32f1xx_hal_pwr.c"
...
void HAL_PWR_DeInit(void)
{
  (((RCC_TypeDef *)((0x40000000UL + 0x00020000UL) + 0x00001000UL))->APB1RSTR |= ((0x1UL << (28U))));
  (((RCC_TypeDef *)((0x40000000UL + 0x00020000UL) + 0x00001000UL))->APB1RSTR &= ~((0x1UL << (28U))));
}
...
void HAL_PWR_EnableBkUpAccess(void)
{
  ...
  *(volatile uint32_t *) ((uint32_t)(0x42000000UL + ((((0x40000000UL + 0x00007000UL) - 0x40000000UL) + 0x00U) * 32U) + ((8U) * 4U))) = (uint32_t)ENABLE;
}
...
void HAL_PWR_DisableBkUpAccess(void)
{
  ...
  *(volatile uint32_t *) ((uint32_t)(0x42000000UL + ((((0x40000000UL + 0x00007000UL) - 0x40000000UL) + 0x00U) * 32U) + ((8U) * 4U))) = (uint32_t)DISABLE;
}
...
void HAL_PWR_ConfigPVD(PWR_PVDTypeDef *sConfigPVD)
{
  ...
  (((((PWR_TypeDef *)(0x40000000UL + 0x00007000UL))->CR)) = ((((((((PWR_TypeDef *)(0x40000000UL + 0x00007000UL))->CR))) & (~((0x7UL << (5U))))) | (sConfigPVD->PVDLevel))));
  
   
  ((((EXTI_TypeDef *)((0x40000000UL + 0x00010000UL) + 0x00000400UL))->EMR) &= ~(((uint32_t)0x00010000)));
  ((((EXTI_TypeDef *)((0x40000000UL + 0x00010000UL) + 0x00000400UL))->IMR) &= ~(((uint32_t)0x00010000)));
  ((((EXTI_TypeDef *)((0x40000000UL + 0x00010000UL) + 0x00000400UL))->FTSR) &= ~(((uint32_t)0x00010000))); 
  ((((EXTI_TypeDef *)((0x40000000UL + 0x00010000UL) + 0x00000400UL))->RTSR) &= ~(((uint32_t)0x00010000)));

   
  if((sConfigPVD->Mode & 0x00010000U) == 0x00010000U)
  {
    ((((EXTI_TypeDef *)((0x40000000UL + 0x00010000UL) + 0x00000400UL))->IMR) |= (((uint32_t)0x00010000)));
  }
  
   
  if((sConfigPVD->Mode & 0x00020000U) == 0x00020000U)
  {
    ((((EXTI_TypeDef *)((0x40000000UL + 0x00010000UL) + 0x00000400UL))->EMR) |= (((uint32_t)0x00010000)));
  }
  
   
  if((sConfigPVD->Mode & 0x00000001U) == 0x00000001U)
  {
    ((((EXTI_TypeDef *)((0x40000000UL + 0x00010000UL) + 0x00000400UL))->RTSR) |= (((uint32_t)0x00010000)));
  }
  
  if((sConfigPVD->Mode & 0x00000002U) == 0x00000002U)
  {
    ((((EXTI_TypeDef *)((0x40000000UL + 0x00010000UL) + 0x00000400UL))->FTSR) |= (((uint32_t)0x00010000)));
  }
}
...
void HAL_PWR_EnablePVD(void)
{
  ...
  *(volatile uint32_t *) ((uint32_t)(0x42000000UL + ((((0x40000000UL + 0x00007000UL) - 0x40000000UL) + 0x00U) * 32U) + ((4U) * 4U))) = (uint32_t)ENABLE;
}
...
void HAL_PWR_DisablePVD(void)
{
  ...
  *(volatile uint32_t *) ((uint32_t)(0x42000000UL + ((((0x40000000UL + 0x00007000UL) - 0x40000000UL) + 0x00U) * 32U) + ((4U) * 4U))) = (uint32_t)DISABLE;
}
...
void HAL_PWR_EnableWakeUpPin(uint32_t WakeUpPinx)
{
  ...
  *(volatile uint32_t *) ((uint32_t)(0x42000000UL + ((((0x40000000UL + 0x00007000UL) - 0x40000000UL) + 0x04U) * 32U) + ((__clz(__rbit(WakeUpPinx))) * 4U))) = (uint32_t)ENABLE;
}
...
void HAL_PWR_DisableWakeUpPin(uint32_t WakeUpPinx)
{
  ...
  *(volatile uint32_t *) ((uint32_t)(0x42000000UL + ((((0x40000000UL + 0x00007000UL) - 0x40000000UL) + 0x04U) * 32U) + ((__clz(__rbit(WakeUpPinx))) * 4U))) = (uint32_t)DISABLE;
}
...
void HAL_PWR_EnterSTOPMode(uint32_t Regulator, uint8_t STOPEntry)
{
  ...
  ((((PWR_TypeDef *)(0x40000000UL + 0x00007000UL))->CR) &= ~((0x1UL << (1U))));

   
  (((((PWR_TypeDef *)(0x40000000UL + 0x00007000UL))->CR)) = ((((((((PWR_TypeDef *)(0x40000000UL + 0x00007000UL))->CR))) & (~((0x1UL << (0U))))) | (Regulator))));

   
  ((((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->SCR) |= (((uint32_t)(1UL << 2U))));

   
  if(STOPEntry == ((uint8_t)0x01))
  {
...
void HAL_PWR_PVD_IRQHandler(void)
{
  ...
  if((((EXTI_TypeDef *)((0x40000000UL + 0x00010000UL) + 0x00000400UL))->PR & (((uint32_t)0x00010000))) != RESET)
  {
     
    HAL_PWR_PVDCallback();

     
    (((EXTI_TypeDef *)((0x40000000UL + 0x00010000UL) + 0x00000400UL))->PR = (((uint32_t)0x00010000)));
  }
}
