...
#line 320 "../Drivers/STM32F1xx_HAL_Driver/Src/stm32f1xx_hal_i2c.c"
...
#line 349 "../Drivers/STM32F1xx_HAL_Driver/Src/stm32f1xx_hal_i2c.c"
...
#line 511 "../Drivers/STM32F1xx_HAL_Driver/Src/stm32f1xx_hal_i2c.c"
...
#line 603 "../Drivers/STM32F1xx_HAL_Driver/Src/stm32f1xx_hal_i2c.c"
...
#line 971 "../Drivers/STM32F1xx_HAL_Driver/Src/stm32f1xx_hal_i2c.c"
...
static void I2C_Flush_DR(I2C_HandleTypeDef *hi2c)
{
  ...
  if (((((uint8_t)((0x00010080U) >> 16U)) == 0x01U) ? (((((hi2c)->Instance ->SR1) & ((0x00010080U) & 0x0000FFFFU)) == ((0x00010080U) & 0x0000FFFFU)) ? SET : RESET) : (((((hi2c)->Instance ->SR2) & ((0x00010080U) & 0x0000FFFFU)) == ((0x00010080U) & 0x0000FFFFU)) ? SET : RESET)) != RESET)
  {
...
HAL_StatusTypeDef HAL_I2C_Master_Transmit(I2C_HandleTypeDef *hi2c, uint16_t DevAddress, uint8_t *pData, uint16_t Size, uint32_t Timeout)
{
  ...
  if (hi2c->State == HAL_I2C_STATE_READY)
  {
    ...
    if (I2C_WaitOnFlagUntilTimeout(hi2c, 0x00100002U, SET, 25U, tickstart) != HAL_OK)
    {
      return HAL_BUSY;
    }
    ...
    if ((hi2c->Instance->CR1 & (0x1UL << (0U))) != (0x1UL << (0U)))
    {
    ...
    while (hi2c->XferSize > 0U)
    {
      ...
      {
        if (hi2c->ErrorCode == 0x00000004U)
        {
           
          ((hi2c->Instance ->CR1) |= ((0x1UL << (9U))));
        }
        return HAL_ERROR;
      }
      ...
      if ((((((uint8_t)((0x00010004U) >> 16U)) == 0x01U) ? (((((hi2c)->Instance ->SR1) & ((0x00010004U) & 0x0000FFFFU)) == ((0x00010004U) & 0x0000FFFFU)) ? SET : RESET) : (((((hi2c)->Instance ->SR2) & ((0x00010004U) & 0x0000FFFFU)) == ((0x00010004U) & 0x0000FFFFU)) ? SET : RESET)) == SET) && (hi2c->XferSize != 0U))
      {
    ...
    while (hi2c->XferSize > 0U)
    {
      if (hi2c->XferSize <= 3U)
      {
        ...
        else if (hi2c->XferSize == 2U)
        {
          ...
          if (I2C_WaitOnFlagUntilTimeout(hi2c, 0x00010004U, RESET, Timeout, tickstart) != HAL_OK)
          {
            return HAL_ERROR;
          }
        ...
        else
        {
          ...
          *hi2c->pBuffPtr = (uint8_t)hi2c->Instance->DR;
          ...
          count = 35U * (SystemCoreClock / 25U / 1000U);
          do
          {
            count--;
            if (count == 0U)
          ...
          while (((((uint8_t)((0x00010004U) >> 16U)) == 0x01U) ? (((((hi2c)->Instance ->SR1) & ((0x00010004U) & 0x0000FFFFU)) == ((0x00010004U) & 0x0000FFFFU)) ? SET : RESET) : (((((hi2c)->Instance ->SR2) & ((0x00010004U) & 0x0000FFFFU)) == ((0x00010004U) & 0x0000FFFFU)) ? SET : RESET)) == RESET);
      ...
      else
      {
        ...
        *hi2c->pBuffPtr = (uint8_t)hi2c->Instance->DR;
        ...
        if (((((uint8_t)((0x00010004U) >> 16U)) == 0x01U) ? (((((hi2c)->Instance ->SR1) & ((0x00010004U) & 0x0000FFFFU)) == ((0x00010004U) & 0x0000FFFFU)) ? SET : RESET) : (((((hi2c)->Instance ->SR2) & ((0x00010004U) & 0x0000FFFFU)) == ((0x00010004U) & 0x0000FFFFU)) ? SET : RESET)) == SET)
        {
...
HAL_StatusTypeDef HAL_I2C_Slave_Transmit(I2C_HandleTypeDef *hi2c, uint8_t *pData, uint16_t Size, uint32_t Timeout)
{
  ...
  if (hi2c->State == HAL_I2C_STATE_READY)
  {
    ...
    if (I2C_WaitOnFlagUntilTimeout(hi2c, 0x00010002U, RESET, Timeout, tickstart) != HAL_OK)
    {
      return HAL_ERROR;
    }
    ...
    if (hi2c->Init.AddressingMode == ((0x1UL << (15U)) | 0x00004000U))
    {
    ...
    if (I2C_WaitOnFlagUntilTimeout(hi2c, 0x00010400U, RESET, Timeout, tickstart) != HAL_OK)
    {
      return HAL_ERROR;
    }

     
    ((hi2c)->Instance ->SR1 = ~((0x00010400U) & 0x0000FFFFU));
...
HAL_StatusTypeDef HAL_I2C_Slave_Receive(I2C_HandleTypeDef *hi2c, uint8_t *pData, uint16_t Size, uint32_t Timeout)
{
  ...
  if (hi2c->State == HAL_I2C_STATE_READY)
  {
    ...
    do{ volatile uint32_t tmpreg = 0x00U; tmpreg = (hi2c)->Instance ->SR1; (((hi2c)->Instance ->CR1) |= ((0x1UL << (0U)))); (void)tmpreg; } while(0);
...
HAL_StatusTypeDef HAL_I2C_Master_Transmit_IT(I2C_HandleTypeDef *hi2c, uint16_t DevAddress, uint8_t *pData, uint16_t Size)
{
  ...
  if (hi2c->State == HAL_I2C_STATE_READY)
  {
    ...
    while (((((uint8_t)((0x00100002U) >> 16U)) == 0x01U) ? (((((hi2c)->Instance ->SR1) & ((0x00100002U) & 0x0000FFFFU)) == ((0x00100002U) & 0x0000FFFFU)) ? SET : RESET) : (((((hi2c)->Instance ->SR2) & ((0x00100002U) & 0x0000FFFFU)) == ((0x00100002U) & 0x0000FFFFU)) ? SET : RESET)) != RESET);
    ...
    (((hi2c)->Instance ->CR2) |= (((0x1UL << (9U)) | (0x1UL << (10U)) | (0x1UL << (8U)))));

     
    ((hi2c->Instance ->CR1) |= ((0x1UL << (8U))));
  ...
  if (hi2c->State == HAL_I2C_STATE_READY)
  {
    ...
    if (hi2c->XferSize > 0U)
    {
      ...
      if (dmaxferstatus == HAL_OK)
      {
        ...
        (((hi2c)->Instance ->CR2) |= (((0x1UL << (9U)) | (0x1UL << (8U)))));

         
        ((hi2c->Instance ->CR2) |= ((0x1UL << (11U))));
  ...
  if (hi2c->State == HAL_I2C_STATE_READY)
  {
    ...
    if (hi2c->XferSize > 0U)
    {
      ...
      if (dmaxferstatus == HAL_OK)
      {
        ...
        if (I2C_RequestMemoryWrite(hi2c, DevAddress, MemAddress, MemAddSize, 35U, tickstart) != HAL_OK)
        {
          ...
          hi2c->hdmatx->XferCpltCallback = 0;
  ...
  if (hi2c->State == HAL_I2C_STATE_READY)
  {
    ...
    if (hi2c->XferSize > 0U)
    {
      ...
      if (dmaxferstatus == HAL_OK)
      {
        ...
        if (I2C_RequestMemoryRead(hi2c, DevAddress, MemAddress, MemAddSize, 35U, tickstart) != HAL_OK)
        {
          ...
          hi2c->hdmarx->XferCpltCallback = 0;
...
HAL_StatusTypeDef HAL_I2C_IsDeviceReady(I2C_HandleTypeDef *hi2c, uint16_t DevAddress, uint32_t Trials, uint32_t Timeout)
{
  ...
  if (hi2c->State == HAL_I2C_STATE_READY)
  {
    ...
    do
    {
      ...
      if (I2C_WaitOnFlagUntilTimeout(hi2c, 0x00010001U, RESET, Timeout, tickstart) != HAL_OK)
      {
        if (((hi2c->Instance ->CR1) & ((0x1UL << (8U)))) == (0x1UL << (8U)))
        {
          hi2c->ErrorCode = 0x00000200U;
        }
        return HAL_TIMEOUT;
      }

       
      hi2c->Instance->DR = ((uint8_t)((DevAddress) & (uint8_t)(~(0x1UL << (0U)))));

       
       
      tickstart = HAL_GetTick();

      tmp1 = ((((uint8_t)((0x00010002U) >> 16U)) == 0x01U) ? (((((hi2c)->Instance ->SR1) & ((0x00010002U) & 0x0000FFFFU)) == ((0x00010002U) & 0x0000FFFFU)) ? SET : RESET) : (((((hi2c)->Instance ->SR2) & ((0x00010002U) & 0x0000FFFFU)) == ((0x00010002U) & 0x0000FFFFU)) ? SET : RESET));
      tmp2 = ((((uint8_t)((0x00010400U) >> 16U)) == 0x01U) ? (((((hi2c)->Instance ->SR1) & ((0x00010400U) & 0x0000FFFFU)) == ((0x00010400U) & 0x0000FFFFU)) ? SET : RESET) : (((((hi2c)->Instance ->SR2) & ((0x00010400U) & 0x0000FFFFU)) == ((0x00010400U) & 0x0000FFFFU)) ? SET : RESET));
      ...
      if (((((uint8_t)((0x00010002U) >> 16U)) == 0x01U) ? (((((hi2c)->Instance ->SR1) & ((0x00010002U) & 0x0000FFFFU)) == ((0x00010002U) & 0x0000FFFFU)) ? SET : RESET) : (((((hi2c)->Instance ->SR2) & ((0x00010002U) & 0x0000FFFFU)) == ((0x00010002U) & 0x0000FFFFU)) ? SET : RESET)) == SET)
      {
...
HAL_StatusTypeDef HAL_I2C_Master_Seq_Transmit_IT(I2C_HandleTypeDef *hi2c, uint16_t DevAddress, uint8_t *pData, uint16_t Size, uint32_t XferOptions)
{
  ...
  if (hi2c->State == HAL_I2C_STATE_READY)
  {
    ...
    if ((((hi2c->Instance ->CR1) & ((0x1UL << (9U)))) == (0x1UL << (9U))) || (XferOptions == 0x00000008U) || (XferOptions == 0x00000001U))
    {
    ...
    if ((Prev_State != ((uint32_t)(((uint32_t)HAL_I2C_STATE_BUSY_TX & ((uint32_t)((uint32_t)((uint32_t)HAL_I2C_STATE_BUSY_TX | (uint32_t)HAL_I2C_STATE_BUSY_RX) & (uint32_t)(~((uint32_t)HAL_I2C_STATE_READY))))) | (uint32_t)HAL_I2C_MODE_MASTER))) || ((((XferOptions) == (0x00AA0000U)) || ((XferOptions) == (0xAA000000U))) == 1))
    {
  ...
  if (hi2c->State == HAL_I2C_STATE_READY)
  {
    ...
    if (hi2c->XferSize > 0U)
    {
      ...
      if (dmaxferstatus == HAL_OK)
      {
        ...
        if ((XferOptions == 0x00000004U) || (XferOptions == 0x00000020U) || (XferOptions == 0x00000010U))
        {
...
HAL_StatusTypeDef HAL_I2C_Master_Seq_Receive_IT(I2C_HandleTypeDef *hi2c, uint16_t DevAddress, uint8_t *pData, uint16_t Size, uint32_t XferOptions)
{
  volatile uint32_t Prev_State = 0x00U;
  volatile uint32_t count = 0U;
  uint32_t enableIT = ((0x1UL << (9U)) | (0x1UL << (10U)) | (0x1UL << (8U)));
  ...
  if (hi2c->State == HAL_I2C_STATE_READY)
  {
    ...
    if ((hi2c->XferCount == 2U) && ((XferOptions == 0x00000020U) || (XferOptions == 0x00000010U)))
    {
      if (Prev_State == ((uint32_t)(((uint32_t)HAL_I2C_STATE_BUSY_RX & ((uint32_t)((uint32_t)((uint32_t)HAL_I2C_STATE_BUSY_TX | (uint32_t)HAL_I2C_STATE_BUSY_RX) & (uint32_t)(~((uint32_t)HAL_I2C_STATE_READY))))) | (uint32_t)HAL_I2C_MODE_MASTER)))
      {
    ...
    if ((Prev_State != ((uint32_t)(((uint32_t)HAL_I2C_STATE_BUSY_RX & ((uint32_t)((uint32_t)((uint32_t)HAL_I2C_STATE_BUSY_TX | (uint32_t)HAL_I2C_STATE_BUSY_RX) & (uint32_t)(~((uint32_t)HAL_I2C_STATE_READY))))) | (uint32_t)HAL_I2C_MODE_MASTER))) || ((((XferOptions) == (0x00AA0000U)) || ((XferOptions) == (0xAA000000U))) == 1))
    {
  ...
  if (hi2c->State == HAL_I2C_STATE_READY)
  {
    ...
    if (hi2c->XferSize > 0U)
    {
      ...
      else
      {
        ...
        if ((XferOptions == 0x00000020U) || (XferOptions == (0xAA000000U)) || (XferOptions == 0x00000010U))
        {
...
HAL_StatusTypeDef HAL_I2C_Slave_Seq_Transmit_DMA(I2C_HandleTypeDef *hi2c, uint8_t *pData, uint16_t Size, uint32_t XferOptions)
{
  ...
  if (((uint32_t)hi2c->State & (uint32_t)HAL_I2C_STATE_LISTEN) == (uint32_t)HAL_I2C_STATE_LISTEN)
  {
    ...
    {
      if ((hi2c->Instance->CR2 & (0x1UL << (11U))) == (0x1UL << (11U)))
      {
...
HAL_StatusTypeDef HAL_I2C_DisableListen_IT(I2C_HandleTypeDef *hi2c)
{
  ...
  {
    tmp = (uint32_t)(hi2c->State) & ((uint32_t)((uint32_t)((uint32_t)HAL_I2C_STATE_BUSY_TX | (uint32_t)HAL_I2C_STATE_BUSY_RX) & (uint32_t)(~((uint32_t)HAL_I2C_STATE_READY))));
...
HAL_StatusTypeDef HAL_I2C_Master_Abort_IT(I2C_HandleTypeDef *hi2c, uint16_t DevAddress)
{
  ...
  if ((((((uint8_t)((0x00100002U) >> 16U)) == 0x01U) ? (((((hi2c)->Instance ->SR1) & ((0x00100002U) & 0x0000FFFFU)) == ((0x00100002U) & 0x0000FFFFU)) ? SET : RESET) : (((((hi2c)->Instance ->SR2) & ((0x00100002U) & 0x0000FFFFU)) == ((0x00100002U) & 0x0000FFFFU)) ? SET : RESET)) != RESET) && (CurrentMode == HAL_I2C_MODE_MASTER))
  {
...
void HAL_I2C_EV_IRQHandler(I2C_HandleTypeDef *hi2c)
{
  ...
  if ((CurrentMode == HAL_I2C_MODE_MASTER) || (CurrentMode == HAL_I2C_MODE_MEM))
  {
    ...
    if ((((((sr1itflags) & ((0x00010001U) & 0x0000FFFFU)) == ((0x00010001U) & 0x0000FFFFU)) ? SET : RESET) == RESET) && ((((CurrentXferOptions) == (0x00AA0000U)) || ((CurrentXferOptions) == (0xAA000000U))) == 1U))
    {
      return;
    }

     
    if ((((((sr1itflags) & ((0x00010001U) & 0x0000FFFFU)) == ((0x00010001U) & 0x0000FFFFU)) ? SET : RESET) != RESET) && (((((itsources) & ((0x1UL << (9U)))) == ((0x1UL << (9U)))) ? SET : RESET) != RESET))
    {
    ...
    else if ((((((sr1itflags) & ((0x00010008U) & 0x0000FFFFU)) == ((0x00010008U) & 0x0000FFFFU)) ? SET : RESET) != RESET) && (((((itsources) & ((0x1UL << (9U)))) == ((0x1UL << (9U)))) ? SET : RESET) != RESET))
    {
      I2C_Master_ADD10(hi2c);
    }
     
    else if ((((((sr1itflags) & ((0x00010002U) & 0x0000FFFFU)) == ((0x00010002U) & 0x0000FFFFU)) ? SET : RESET) != RESET) && (((((itsources) & ((0x1UL << (9U)))) == ((0x1UL << (9U)))) ? SET : RESET) != RESET))
    {
      I2C_Master_ADDR(hi2c);
    }
     
    else if (((((sr2itflags) & ((0x00100004U) & 0x0000FFFFU)) == ((0x00100004U) & 0x0000FFFFU)) ? SET : RESET) != RESET)
    {
       
      if (((hi2c->Instance ->CR2) & ((0x1UL << (11U)))) != (0x1UL << (11U)))
      {
         
        if ((((((sr1itflags) & ((0x00010080U) & 0x0000FFFFU)) == ((0x00010080U) & 0x0000FFFFU)) ? SET : RESET) != RESET) && (((((itsources) & ((0x1UL << (10U)))) == ((0x1UL << (10U)))) ? SET : RESET) != RESET) && (((((sr1itflags) & ((0x00010004U) & 0x0000FFFFU)) == ((0x00010004U) & 0x0000FFFFU)) ? SET : RESET) == RESET))
        {
          I2C_MasterTransmit_TXE(hi2c);
        }
         
        else if ((((((sr1itflags) & ((0x00010004U) & 0x0000FFFFU)) == ((0x00010004U) & 0x0000FFFFU)) ? SET : RESET) != RESET) && (((((itsources) & ((0x1UL << (9U)))) == ((0x1UL << (9U)))) ? SET : RESET) != RESET))
        {
    ...
    else
    {
      ...
      if (((hi2c->Instance ->CR2) & ((0x1UL << (11U)))) != (0x1UL << (11U)))
      {
        ...
        if ((((((sr1itflags) & ((0x00010040U) & 0x0000FFFFU)) == ((0x00010040U) & 0x0000FFFFU)) ? SET : RESET) != RESET) && (((((itsources) & ((0x1UL << (10U)))) == ((0x1UL << (10U)))) ? SET : RESET) != RESET) && (((((sr1itflags) & ((0x00010004U) & 0x0000FFFFU)) == ((0x00010004U) & 0x0000FFFFU)) ? SET : RESET) == RESET))
        {
  ...
  else
  {
    ...
    if ((((((sr1itflags) & ((0x00010002U) & 0x0000FFFFU)) == ((0x00010002U) & 0x0000FFFFU)) ? SET : RESET) != RESET) && (((((itsources) & ((0x1UL << (9U)))) == ((0x1UL << (9U)))) ? SET : RESET) != RESET))
    {
    ...
    else if ((((((sr1itflags) & ((0x00010010U) & 0x0000FFFFU)) == ((0x00010010U) & 0x0000FFFFU)) ? SET : RESET) != RESET) && (((((itsources) & ((0x1UL << (9U)))) == ((0x1UL << (9U)))) ? SET : RESET) != RESET))
    {
...
void HAL_I2C_ER_IRQHandler(I2C_HandleTypeDef *hi2c)
{
  ...
  uint32_t itsources  = ((hi2c->Instance ->CR2));
  uint32_t error      = 0x00000000U;
  HAL_I2C_ModeTypeDef CurrentMode   = hi2c->Mode;

   
  if ((((((sr1itflags) & ((0x00010100U) & 0x0000FFFFU)) == ((0x00010100U) & 0x0000FFFFU)) ? SET : RESET) != RESET) && (((((itsources) & ((0x1UL << (8U)))) == ((0x1UL << (8U)))) ? SET : RESET) != RESET))
  {
    error |= 0x00000001U;

     
    ((hi2c)->Instance ->SR1 = ~((0x00010100U) & 0x0000FFFFU));
  ...
  if ((((((sr1itflags) & ((0x00010200U) & 0x0000FFFFU)) == ((0x00010200U) & 0x0000FFFFU)) ? SET : RESET) != RESET) && (((((itsources) & ((0x1UL << (8U)))) == ((0x1UL << (8U)))) ? SET : RESET) != RESET))
  {
    error |= 0x00000002U;

     
    ((hi2c)->Instance ->SR1 = ~((0x00010200U) & 0x0000FFFFU));
  }

   
  if ((((((sr1itflags) & ((0x00010400U) & 0x0000FFFFU)) == ((0x00010400U) & 0x0000FFFFU)) ? SET : RESET) != RESET) && (((((itsources) & ((0x1UL << (8U)))) == ((0x1UL << (8U)))) ? SET : RESET) != RESET))
  {
    tmp1 = CurrentMode;
    tmp2 = hi2c->XferCount;
    tmp3 = hi2c->State;
    tmp4 = hi2c->PreviousState;
    if ((tmp1 == HAL_I2C_MODE_SLAVE) && (tmp2 == 0U) &&         ((tmp3 == HAL_I2C_STATE_BUSY_TX) || (tmp3 == HAL_I2C_STATE_BUSY_TX_LISTEN) ||          ((tmp3 == HAL_I2C_STATE_LISTEN) && (tmp4 == ((uint32_t)(((uint32_t)HAL_I2C_STATE_BUSY_TX & ((uint32_t)((uint32_t)((uint32_t)HAL_I2C_STATE_BUSY_TX | (uint32_t)HAL_I2C_STATE_BUSY_RX) & (uint32_t)(~((uint32_t)HAL_I2C_STATE_READY))))) | (uint32_t)HAL_I2C_MODE_SLAVE))))))
  ...
  if ((((((sr1itflags) & ((0x00010800U) & 0x0000FFFFU)) == ((0x00010800U) & 0x0000FFFFU)) ? SET : RESET) != RESET) && (((((itsources) & ((0x1UL << (8U)))) == ((0x1UL << (8U)))) ? SET : RESET) != RESET))
  {
    error |= 0x00000008U;
     
    ((hi2c)->Instance ->SR1 = ~((0x00010800U) & 0x0000FFFFU));
  }

   
  if (error != 0x00000000U)
  {
...
static void I2C_MasterTransmit_TXE(I2C_HandleTypeDef *hi2c)
{
  ...
  if ((hi2c->XferSize == 0U) && (CurrentState == HAL_I2C_STATE_BUSY_TX))
  {
    ...
    if ((CurrentXferOptions != 0x00000008U) && (CurrentXferOptions != 0x00000020U) && (CurrentXferOptions != 0xFFFF0000U))
    {
      (((hi2c)->Instance ->CR2) &= ~(((0x1UL << (9U)) | (0x1UL << (10U)) | (0x1UL << (8U)))));

      hi2c->PreviousState = ((uint32_t)(((uint32_t)HAL_I2C_STATE_BUSY_TX & ((uint32_t)((uint32_t)((uint32_t)HAL_I2C_STATE_BUSY_TX | (uint32_t)HAL_I2C_STATE_BUSY_RX) & (uint32_t)(~((uint32_t)HAL_I2C_STATE_READY))))) | (uint32_t)HAL_I2C_MODE_MASTER));
      hi2c->Mode = HAL_I2C_MODE_NONE;
      hi2c->State = HAL_I2C_STATE_READY;
...
static void I2C_MemoryTransmit_TXE_BTF(I2C_HandleTypeDef *hi2c)
{
  ...
  if (hi2c->EventCount == 0U)
  {
    ...
    if (hi2c->MemaddSize == 0x00000001U)
    {
       
      hi2c->Instance->DR = ((uint8_t)((uint16_t)((hi2c->Memaddress) & (uint16_t)0x00FF)));
    ...
    else
    {
      ...
      hi2c->Instance->DR = ((uint8_t)((uint16_t)(((uint16_t)((hi2c->Memaddress) & (uint16_t)0xFF00)) >> 8)));
...
static void I2C_MasterReceive_RXNE(I2C_HandleTypeDef *hi2c)
{
  if (hi2c->State == HAL_I2C_STATE_BUSY_RX)
  {
    ...
    else if ((hi2c->XferOptions != 0x00000002U) && ((tmp == 1U) || (tmp == 0U)))
    {
      if (I2C_WaitOnSTOPRequestThroughIT(hi2c) == HAL_OK)
      {
        ...
        *hi2c->pBuffPtr = (uint8_t)hi2c->Instance->DR;
        ...
        {
          hi2c->Mode = HAL_I2C_MODE_NONE;
          hi2c->PreviousState = ((uint32_t)(((uint32_t)HAL_I2C_STATE_BUSY_RX & ((uint32_t)((uint32_t)((uint32_t)HAL_I2C_STATE_BUSY_TX | (uint32_t)HAL_I2C_STATE_BUSY_RX) & (uint32_t)(~((uint32_t)HAL_I2C_STATE_READY))))) | (uint32_t)HAL_I2C_MODE_MASTER));
...
static void I2C_MasterReceive_BTF(I2C_HandleTypeDef *hi2c)
{
  ...
  else if (hi2c->XferCount == 3U)
  {
    ...
    if ((CurrentXferOptions != 0x00000004U) && (CurrentXferOptions != 0x00000002U))
    {
  ...
  else if (hi2c->XferCount == 2U)
  {
    ...
    if ((CurrentXferOptions == 0x00000001U) || (CurrentXferOptions == 0x00000010U))
    {
       
      ((hi2c->Instance ->CR1) &= ~((0x1UL << (10U))));
    }
    else if ((CurrentXferOptions == 0x00000004U) || (CurrentXferOptions == 0x00000002U))
    {
       
      ((hi2c->Instance ->CR1) |= ((0x1UL << (10U))));
    }
    else if (CurrentXferOptions != 0x00000010U)
    {
...
static void I2C_Master_SB(I2C_HandleTypeDef *hi2c)
{
  if (hi2c->Mode == HAL_I2C_MODE_MEM)
  {
    if (hi2c->EventCount == 0U)
    {
      ...
      hi2c->Instance->DR = ((uint8_t)((hi2c->Devaddress) & (uint8_t)(~(0x1UL << (0U)))));
    }
    else
    {
      hi2c->Instance->DR = ((uint8_t)((hi2c->Devaddress) | (0x1UL << (0U))));
    }
  }
  else
  {
    if (hi2c->Init.AddressingMode == 0x00004000U)
    {
      ...
      if (((hi2c->hdmatx != 0) && (hi2c->hdmatx->XferCpltCallback != 0))
          || ((hi2c->hdmarx != 0) && (hi2c->hdmarx->XferCpltCallback != 0)))
      {
    ...
    else
    {
      if (hi2c->EventCount == 0U)
      {
        ...
        hi2c->Instance->DR = ((uint8_t)((uint16_t)((uint16_t)(((uint16_t)((hi2c->Devaddress) & (uint16_t)0x0300)) >> 7) | (uint16_t)0x00F0)));
      }
      else if (hi2c->EventCount == 1U)
      {
         
        hi2c->Instance->DR = ((uint8_t)((uint16_t)((uint16_t)(((uint16_t)((hi2c->Devaddress) & (uint16_t)0x0300)) >> 7) | (uint16_t)(0x00F1))));
      }
      else
      {
...
static void I2C_Master_ADD10(I2C_HandleTypeDef *hi2c)
{
  ...
  hi2c->Instance->DR = ((uint8_t)((uint16_t)((hi2c->Devaddress) & (uint16_t)0x00FF)));
...
static void I2C_Master_ADDR(I2C_HandleTypeDef *hi2c)
{
  ...
  if (hi2c->State == HAL_I2C_STATE_BUSY_RX)
  {
    ...
    else if ((hi2c->EventCount == 0U) && (hi2c->Init.AddressingMode == ((0x1UL << (15U)) | 0x00004000U)))
    {
    ...
    else
    {
      ...
      {
        if (CurrentXferOptions == 0xFFFF0000U)
        {
        ...
        else if ((CurrentXferOptions != 0x00000008U) && (CurrentXferOptions != 0x00000020U)                  && ((Prev_State != ((uint32_t)(((uint32_t)HAL_I2C_STATE_BUSY_RX & ((uint32_t)((uint32_t)((uint32_t)HAL_I2C_STATE_BUSY_TX | (uint32_t)HAL_I2C_STATE_BUSY_RX) & (uint32_t)(~((uint32_t)HAL_I2C_STATE_READY))))) | (uint32_t)HAL_I2C_MODE_MASTER))) || (CurrentXferOptions == 0x00000001U)))

        {
          if ((CurrentXferOptions != 0x00000004U) && (CurrentXferOptions != 0x00000002U) && (CurrentXferOptions != 0x00000010U))
          {
      ...
      else if (hi2c->XferCount == 2U)
      {
        ...
        if (((hi2c->Instance->CR2 & (0x1UL << (11U))) == (0x1UL << (11U))) && ((CurrentXferOptions == 0xFFFF0000U) || (CurrentXferOptions == 0x00000001U) || (CurrentXferOptions == 0x00000008U) || (CurrentXferOptions == 0x00000010U) || (CurrentXferOptions == 0x00000020U)))
        {
...
static void I2C_SlaveTransmit_TXE(I2C_HandleTypeDef *hi2c)
{
  ...
  if (hi2c->XferCount != 0U)
  {
    ...
    if ((hi2c->XferCount == 0U) && (CurrentState == HAL_I2C_STATE_BUSY_TX_LISTEN))
    {
      ...
      hi2c->PreviousState = ((uint32_t)(((uint32_t)HAL_I2C_STATE_BUSY_TX & ((uint32_t)((uint32_t)((uint32_t)HAL_I2C_STATE_BUSY_TX | (uint32_t)HAL_I2C_STATE_BUSY_RX) & (uint32_t)(~((uint32_t)HAL_I2C_STATE_READY))))) | (uint32_t)HAL_I2C_MODE_SLAVE));
      hi2c->State = HAL_I2C_STATE_LISTEN;
  ...
  if (hi2c->XferCount != 0U)
  {
    ...
    *hi2c->pBuffPtr = (uint8_t)hi2c->Instance->DR;
    ...
    if ((hi2c->XferCount == 0U) && (CurrentState == HAL_I2C_STATE_BUSY_RX_LISTEN))
    {
      ...
      hi2c->PreviousState = ((uint32_t)(((uint32_t)HAL_I2C_STATE_BUSY_RX & ((uint32_t)((uint32_t)((uint32_t)HAL_I2C_STATE_BUSY_TX | (uint32_t)HAL_I2C_STATE_BUSY_RX) & (uint32_t)(~((uint32_t)HAL_I2C_STATE_READY))))) | (uint32_t)HAL_I2C_MODE_SLAVE));
      hi2c->State = HAL_I2C_STATE_LISTEN;
...
static void I2C_Slave_ADDR(I2C_HandleTypeDef *hi2c, uint32_t IT2Flags)
{
  uint8_t TransferDirection = 0x00000000U;
  ...
  if (((uint32_t)hi2c->State & (uint32_t)HAL_I2C_STATE_LISTEN) == (uint32_t)HAL_I2C_STATE_LISTEN)
  {
    ...
    if (((((IT2Flags) & ((0x00100004U) & 0x0000FFFFU)) == ((0x00100004U) & 0x0000FFFFU)) ? SET : RESET) == RESET)
    {
      TransferDirection = 0x00000001U;
    }

    if (((((IT2Flags) & ((0x00100080U) & 0x0000FFFFU)) == ((0x00100080U) & 0x0000FFFFU)) ? SET : RESET) == RESET)
    {
...
static void I2C_Slave_STOPF(I2C_HandleTypeDef *hi2c)
{
  ...
  if (hi2c->XferCount != 0U)
  {
    ...
    if (((((uint8_t)((0x00010040U) >> 16U)) == 0x01U) ? (((((hi2c)->Instance ->SR1) & ((0x00010040U) & 0x0000FFFFU)) == ((0x00010040U) & 0x0000FFFFU)) ? SET : RESET) : (((((hi2c)->Instance ->SR2) & ((0x00010040U) & 0x0000FFFFU)) == ((0x00010040U) & 0x0000FFFFU)) ? SET : RESET)) == SET)
    {
  ...
  else
  {
    ...
    {
      if ((hi2c->PreviousState  == ((uint32_t)(((uint32_t)HAL_I2C_STATE_BUSY_RX & ((uint32_t)((uint32_t)((uint32_t)HAL_I2C_STATE_BUSY_TX | (uint32_t)HAL_I2C_STATE_BUSY_RX) & (uint32_t)(~((uint32_t)HAL_I2C_STATE_READY))))) | (uint32_t)HAL_I2C_MODE_SLAVE))) || (CurrentState == HAL_I2C_STATE_BUSY_RX))
      {
        hi2c->PreviousState = ((uint32_t)(HAL_I2C_MODE_NONE));
        hi2c->State = HAL_I2C_STATE_READY;
        hi2c->Mode = HAL_I2C_MODE_NONE;
...
static void I2C_Slave_AF(I2C_HandleTypeDef *hi2c)
{
  ...
  if (((CurrentXferOptions ==  0x00000008U) || (CurrentXferOptions == 0x00000020U)) &&       (CurrentState == HAL_I2C_STATE_LISTEN))
...
static void I2C_ITError(I2C_HandleTypeDef *hi2c)
{
  ...
  else
  {
    ...
    if ((((hi2c->Instance ->CR2) & ((0x1UL << (11U)))) != (0x1UL << (11U))) && (CurrentState != HAL_I2C_STATE_ABORT))
    {
      hi2c->State = HAL_I2C_STATE_READY;
      hi2c->Mode = HAL_I2C_MODE_NONE;
    }
  ...
  if (((CurrentError & 0x00000001U) == 0x00000001U) ||       ((CurrentError & 0x00000002U) == 0x00000002U) ||       ((CurrentError & 0x00000004U) == 0x00000004U)     ||       ((CurrentError & 0x00000008U) == 0x00000008U))
  ...
  if (((hi2c->ErrorCode & 0x00000004U) == 0x00000004U) && (CurrentState == HAL_I2C_STATE_LISTEN))
  {
    hi2c->XferOptions   = 0xFFFF0000U;
    hi2c->PreviousState = ((uint32_t)(HAL_I2C_MODE_NONE));
    hi2c->State         = HAL_I2C_STATE_READY;
...
static HAL_StatusTypeDef I2C_MasterRequestWrite(I2C_HandleTypeDef *hi2c, uint16_t DevAddress, uint32_t Timeout, uint32_t Tickstart)
{
  ...
  if ((CurrentXferOptions == 0x00000008U) || (CurrentXferOptions == 0x00000001U) || (CurrentXferOptions == 0xFFFF0000U))
  {
     
    ((hi2c->Instance ->CR1) |= ((0x1UL << (8U))));
  }
  else if (hi2c->PreviousState == ((uint32_t)(((uint32_t)HAL_I2C_STATE_BUSY_RX & ((uint32_t)((uint32_t)((uint32_t)HAL_I2C_STATE_BUSY_TX | (uint32_t)HAL_I2C_STATE_BUSY_RX) & (uint32_t)(~((uint32_t)HAL_I2C_STATE_READY))))) | (uint32_t)HAL_I2C_MODE_MASTER)))
  {
  ...
  else
  {
    ...
    hi2c->Instance->DR = ((uint8_t)((uint16_t)((uint16_t)(((uint16_t)((DevAddress) & (uint16_t)0x0300)) >> 7) | (uint16_t)0x00F0)));

     
    if (I2C_WaitOnMasterAddressFlagUntilTimeout(hi2c, 0x00010008U, Timeout, Tickstart) != HAL_OK)
    {
      return HAL_ERROR;
    }
  ...
  if (I2C_WaitOnMasterAddressFlagUntilTimeout(hi2c, 0x00010002U, Timeout, Tickstart) != HAL_OK)
  {
    return HAL_ERROR;
  }
...
static HAL_StatusTypeDef I2C_MasterRequestRead(I2C_HandleTypeDef *hi2c, uint16_t DevAddress, uint32_t Timeout, uint32_t Tickstart)
{
  ...
  else if (hi2c->PreviousState == ((uint32_t)(((uint32_t)HAL_I2C_STATE_BUSY_TX & ((uint32_t)((uint32_t)((uint32_t)HAL_I2C_STATE_BUSY_TX | (uint32_t)HAL_I2C_STATE_BUSY_RX) & (uint32_t)(~((uint32_t)HAL_I2C_STATE_READY))))) | (uint32_t)HAL_I2C_MODE_MASTER)))
  {
  ...
  if (hi2c->Init.AddressingMode == 0x00004000U)
  {
    ...
    hi2c->Instance->DR = ((uint8_t)((DevAddress) | (0x1UL << (0U))));
  }
  else
  {
    ...
    hi2c->Instance->DR = ((uint8_t)((uint16_t)((uint16_t)(((uint16_t)((DevAddress) & (uint16_t)0x0300)) >> 7) | (uint16_t)(0x00F1))));
  }
...
static void I2C_DMAXferCplt(DMA_HandleTypeDef *hdma)
{
  ...
  else if (hi2c->Mode != HAL_I2C_MODE_NONE)
  {
    ...
    if ((CurrentXferOptions == 0xFFFF0000U) || (CurrentXferOptions == 0x00000008U) || (CurrentXferOptions == (0xAA000000U)) || (CurrentXferOptions == 0x00000020U))
    {
...
static void I2C_DMAAbort(DMA_HandleTypeDef *hdma)
{
  ...
  while (((hi2c->Instance ->CR1) & ((0x1UL << (9U)))) == (0x1UL << (9U)));
...
static HAL_StatusTypeDef I2C_WaitOnFlagUntilTimeout(I2C_HandleTypeDef *hi2c, uint32_t Flag, FlagStatus Status, uint32_t Timeout, uint32_t Tickstart)
{
  ...
  while (((((uint8_t)((Flag) >> 16U)) == 0x01U) ? (((((hi2c)->Instance ->SR1) & ((Flag) & 0x0000FFFFU)) == ((Flag) & 0x0000FFFFU)) ? SET : RESET) : (((((hi2c)->Instance ->SR2) & ((Flag) & 0x0000FFFFU)) == ((Flag) & 0x0000FFFFU)) ? SET : RESET)) == Status)
  {
    ...
    if (Timeout != 0xFFFFFFFFU)
    {
      if (((HAL_GetTick() - Tickstart) > Timeout) || (Timeout == 0U))
      {
        if ((((((uint8_t)((Flag) >> 16U)) == 0x01U) ? (((((hi2c)->Instance ->SR1) & ((Flag) & 0x0000FFFFU)) == ((Flag) & 0x0000FFFFU)) ? SET : RESET) : (((((hi2c)->Instance ->SR2) & ((Flag) & 0x0000FFFFU)) == ((Flag) & 0x0000FFFFU)) ? SET : RESET)) == Status))
        {
          hi2c->PreviousState     = ((uint32_t)(HAL_I2C_MODE_NONE));
          hi2c->State             = HAL_I2C_STATE_READY;
          hi2c->Mode              = HAL_I2C_MODE_NONE;
...
static HAL_StatusTypeDef I2C_WaitOnMasterAddressFlagUntilTimeout(I2C_HandleTypeDef *hi2c, uint32_t Flag, uint32_t Timeout, uint32_t Tickstart)
{
  while (((((uint8_t)((Flag) >> 16U)) == 0x01U) ? (((((hi2c)->Instance ->SR1) & ((Flag) & 0x0000FFFFU)) == ((Flag) & 0x0000FFFFU)) ? SET : RESET) : (((((hi2c)->Instance ->SR2) & ((Flag) & 0x0000FFFFU)) == ((Flag) & 0x0000FFFFU)) ? SET : RESET)) == RESET)
  {
    if (((((uint8_t)((0x00010400U) >> 16U)) == 0x01U) ? (((((hi2c)->Instance ->SR1) & ((0x00010400U) & 0x0000FFFFU)) == ((0x00010400U) & 0x0000FFFFU)) ? SET : RESET) : (((((hi2c)->Instance ->SR2) & ((0x00010400U) & 0x0000FFFFU)) == ((0x00010400U) & 0x0000FFFFU)) ? SET : RESET)) == SET)
    {
    ...
    if (Timeout != 0xFFFFFFFFU)
    {
      if (((HAL_GetTick() - Tickstart) > Timeout) || (Timeout == 0U))
      {
        if ((((((uint8_t)((Flag) >> 16U)) == 0x01U) ? (((((hi2c)->Instance ->SR1) & ((Flag) & 0x0000FFFFU)) == ((Flag) & 0x0000FFFFU)) ? SET : RESET) : (((((hi2c)->Instance ->SR2) & ((Flag) & 0x0000FFFFU)) == ((Flag) & 0x0000FFFFU)) ? SET : RESET)) == RESET))
        {
          hi2c->PreviousState       = ((uint32_t)(HAL_I2C_MODE_NONE));
          hi2c->State               = HAL_I2C_STATE_READY;
          hi2c->Mode                = HAL_I2C_MODE_NONE;
...
static HAL_StatusTypeDef I2C_WaitOnTXEFlagUntilTimeout(I2C_HandleTypeDef *hi2c, uint32_t Timeout, uint32_t Tickstart)
{
  while (((((uint8_t)((0x00010080U) >> 16U)) == 0x01U) ? (((((hi2c)->Instance ->SR1) & ((0x00010080U) & 0x0000FFFFU)) == ((0x00010080U) & 0x0000FFFFU)) ? SET : RESET) : (((((hi2c)->Instance ->SR2) & ((0x00010080U) & 0x0000FFFFU)) == ((0x00010080U) & 0x0000FFFFU)) ? SET : RESET)) == RESET)
  {
...
static HAL_StatusTypeDef I2C_WaitOnBTFFlagUntilTimeout(I2C_HandleTypeDef *hi2c, uint32_t Timeout, uint32_t Tickstart)
{
  while (((((uint8_t)((0x00010004U) >> 16U)) == 0x01U) ? (((((hi2c)->Instance ->SR1) & ((0x00010004U) & 0x0000FFFFU)) == ((0x00010004U) & 0x0000FFFFU)) ? SET : RESET) : (((((hi2c)->Instance ->SR2) & ((0x00010004U) & 0x0000FFFFU)) == ((0x00010004U) & 0x0000FFFFU)) ? SET : RESET)) == RESET)
  {
    ...
    if (Timeout != 0xFFFFFFFFU)
    {
      if (((HAL_GetTick() - Tickstart) > Timeout) || (Timeout == 0U))
      {
        if ((((((uint8_t)((0x00010004U) >> 16U)) == 0x01U) ? (((((hi2c)->Instance ->SR1) & ((0x00010004U) & 0x0000FFFFU)) == ((0x00010004U) & 0x0000FFFFU)) ? SET : RESET) : (((((hi2c)->Instance ->SR2) & ((0x00010004U) & 0x0000FFFFU)) == ((0x00010004U) & 0x0000FFFFU)) ? SET : RESET)) == RESET))
        {
          hi2c->PreviousState       = ((uint32_t)(HAL_I2C_MODE_NONE));
          hi2c->State               = HAL_I2C_STATE_READY;
          hi2c->Mode                = HAL_I2C_MODE_NONE;
...
static HAL_StatusTypeDef I2C_WaitOnSTOPFlagUntilTimeout(I2C_HandleTypeDef *hi2c, uint32_t Timeout, uint32_t Tickstart)
{
  while (((((uint8_t)((0x00010010U) >> 16U)) == 0x01U) ? (((((hi2c)->Instance ->SR1) & ((0x00010010U) & 0x0000FFFFU)) == ((0x00010010U) & 0x0000FFFFU)) ? SET : RESET) : (((((hi2c)->Instance ->SR2) & ((0x00010010U) & 0x0000FFFFU)) == ((0x00010010U) & 0x0000FFFFU)) ? SET : RESET)) == RESET)
  {
    ...
    if (((HAL_GetTick() - Tickstart) > Timeout) || (Timeout == 0U))
    {
      if ((((((uint8_t)((0x00010010U) >> 16U)) == 0x01U) ? (((((hi2c)->Instance ->SR1) & ((0x00010010U) & 0x0000FFFFU)) == ((0x00010010U) & 0x0000FFFFU)) ? SET : RESET) : (((((hi2c)->Instance ->SR2) & ((0x00010010U) & 0x0000FFFFU)) == ((0x00010010U) & 0x0000FFFFU)) ? SET : RESET)) == RESET))
      {
        hi2c->PreviousState       = ((uint32_t)(HAL_I2C_MODE_NONE));
        hi2c->State               = HAL_I2C_STATE_READY;
        hi2c->Mode                = HAL_I2C_MODE_NONE;
...
static HAL_StatusTypeDef I2C_WaitOnSTOPRequestThroughIT(I2C_HandleTypeDef *hi2c)
{
  ...
  count = 5U * (SystemCoreClock / 25U / 1000U);
  do
  {
    count--;
    if (count == 0U)
...
static HAL_StatusTypeDef I2C_WaitOnRXNEFlagUntilTimeout(I2C_HandleTypeDef *hi2c, uint32_t Timeout, uint32_t Tickstart)
{
  ...
  while (((((uint8_t)((0x00010040U) >> 16U)) == 0x01U) ? (((((hi2c)->Instance ->SR1) & ((0x00010040U) & 0x0000FFFFU)) == ((0x00010040U) & 0x0000FFFFU)) ? SET : RESET) : (((((hi2c)->Instance ->SR2) & ((0x00010040U) & 0x0000FFFFU)) == ((0x00010040U) & 0x0000FFFFU)) ? SET : RESET)) == RESET)
  {
     
    if (((((uint8_t)((0x00010010U) >> 16U)) == 0x01U) ? (((((hi2c)->Instance ->SR1) & ((0x00010010U) & 0x0000FFFFU)) == ((0x00010010U) & 0x0000FFFFU)) ? SET : RESET) : (((((hi2c)->Instance ->SR2) & ((0x00010010U) & 0x0000FFFFU)) == ((0x00010010U) & 0x0000FFFFU)) ? SET : RESET)) == SET)
    {
       
      ((hi2c)->Instance ->SR1 = ~((0x00010010U) & 0x0000FFFFU));
    ...
    if (((HAL_GetTick() - Tickstart) > Timeout) || (Timeout == 0U))
    {
      if ((((((uint8_t)((0x00010040U) >> 16U)) == 0x01U) ? (((((hi2c)->Instance ->SR1) & ((0x00010040U) & 0x0000FFFFU)) == ((0x00010040U) & 0x0000FFFFU)) ? SET : RESET) : (((((hi2c)->Instance ->SR2) & ((0x00010040U) & 0x0000FFFFU)) == ((0x00010040U) & 0x0000FFFFU)) ? SET : RESET)) == RESET))
      {
        hi2c->PreviousState       = ((uint32_t)(HAL_I2C_MODE_NONE));
        hi2c->State               = HAL_I2C_STATE_READY;
        hi2c->Mode                = HAL_I2C_MODE_NONE;
...
static void I2C_ConvertOtherXferOptions(I2C_HandleTypeDef *hi2c)
{
  ...
  if (hi2c->XferOptions == (0x00AA0000U))
  {
    hi2c->XferOptions = 0x00000001U;
  }
   
   
   
   
  else if (hi2c->XferOptions == (0xAA000000U))
  {
    hi2c->XferOptions = 0x00000008U;
  }
  else
  {
