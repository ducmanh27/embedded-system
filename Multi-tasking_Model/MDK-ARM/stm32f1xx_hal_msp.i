#line 1 "../Core/Src/stm32f1xx_hal_msp.c"
...
#line 23 "../Core/Src/stm32f1xx_hal_msp.c"
...
void HAL_MspInit(void)
{
  ...
  do{ uint32_t tmpreg = ((AFIO_TypeDef *)((0x40000000UL + 0x00010000UL) + 0x00000000UL))->MAPR; tmpreg &= ~(0x7UL << (24U)); tmpreg |= (0x1UL << (25U)); ((AFIO_TypeDef *)((0x40000000UL + 0x00010000UL) + 0x00000000UL))->MAPR = tmpreg; }while(0u);
...
void HAL_I2C_MspInit(I2C_HandleTypeDef* hi2c)
{
  ...
  if(hi2c->Instance==((I2C_TypeDef *)(0x40000000UL + 0x00005400UL)))
  {
    ...
    do { volatile uint32_t tmpreg; ((((RCC_TypeDef *)((0x40000000UL + 0x00020000UL) + 0x00001000UL))->APB1ENR) |= ((0x1UL << (21U)))); tmpreg = ((((RCC_TypeDef *)((0x40000000UL + 0x00020000UL) + 0x00001000UL))->APB1ENR) & ((0x1UL << (21U)))); (void)tmpreg; } while(0U);
...
void HAL_I2C_MspDeInit(I2C_HandleTypeDef* hi2c)
{
  if(hi2c->Instance==((I2C_TypeDef *)(0x40000000UL + 0x00005400UL)))
  {
    ...
    (((RCC_TypeDef *)((0x40000000UL + 0x00020000UL) + 0x00001000UL))->APB1ENR &= ~((0x1UL << (21U))));

    


 
    HAL_GPIO_DeInit(((GPIO_TypeDef *)((0x40000000UL + 0x00010000UL) + 0x00000C00UL)), ((uint16_t)0x0040));

    HAL_GPIO_DeInit(((GPIO_TypeDef *)((0x40000000UL + 0x00010000UL) + 0x00000C00UL)), ((uint16_t)0x0080));
...
{
  if(htim_base->Instance==((TIM_TypeDef *)(0x40000000UL + 0x00000400UL)))
  {
   

   
     
    do { volatile uint32_t tmpreg; ((((RCC_TypeDef *)((0x40000000UL + 0x00020000UL) + 0x00001000UL))->APB1ENR) |= ((0x1UL << (1U)))); tmpreg = ((((RCC_TypeDef *)((0x40000000UL + 0x00020000UL) + 0x00001000UL))->APB1ENR) & ((0x1UL << (1U)))); (void)tmpreg; } while(0U);
...
{
  GPIO_InitTypeDef GPIO_InitStruct = {0};
  if(htim->Instance==((TIM_TypeDef *)(0x40000000UL + 0x00000400UL)))
  {
    ...
    HAL_GPIO_Init(((GPIO_TypeDef *)((0x40000000UL + 0x00010000UL) + 0x00000800UL)), &GPIO_InitStruct);
...
{
  GPIO_InitTypeDef GPIO_InitStruct = {0};
  if(huart->Instance==((USART_TypeDef *)(0x40000000UL + 0x00004400UL)))
  {
   

   
     
    do { volatile uint32_t tmpreg; ((((RCC_TypeDef *)((0x40000000UL + 0x00020000UL) + 0x00001000UL))->APB1ENR) |= ((0x1UL << (17U)))); tmpreg = ((((RCC_TypeDef *)((0x40000000UL + 0x00020000UL) + 0x00001000UL))->APB1ENR) & ((0x1UL << (17U)))); (void)tmpreg; } while(0U);
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  if(huart->Instance==((USART_TypeDef *)(0x40000000UL + 0x00004400UL)))
  {
    ...
    (((RCC_TypeDef *)((0x40000000UL + 0x00020000UL) + 0x00001000UL))->APB1ENR &= ~((0x1UL << (17U))));

    


 
    HAL_GPIO_DeInit(((GPIO_TypeDef *)((0x40000000UL + 0x00010000UL) + 0x00000800UL)), ((uint16_t)0x0004)|((uint16_t)0x0008));
