...
#line 187 "../Drivers/STM32F1xx_HAL_Driver/Src/stm32f1xx_hal_tim.c"
...
#line 297 "../Drivers/STM32F1xx_HAL_Driver/Src/stm32f1xx_hal_tim.c"
  ...
  do { (htim)->ChannelState[0] = (HAL_TIM_CHANNEL_STATE_READY); (htim)->ChannelState[1] = (HAL_TIM_CHANNEL_STATE_READY); (htim)->ChannelState[2] = (HAL_TIM_CHANNEL_STATE_READY); (htim)->ChannelState[3] = (HAL_TIM_CHANNEL_STATE_READY); } while(0);
...
#line 344 "../Drivers/STM32F1xx_HAL_Driver/Src/stm32f1xx_hal_tim.c"
  ...
  do { (htim)->ChannelState[0] = (HAL_TIM_CHANNEL_STATE_RESET); (htim)->ChannelState[1] = (HAL_TIM_CHANNEL_STATE_RESET); (htim)->ChannelState[2] = (HAL_TIM_CHANNEL_STATE_RESET); (htim)->ChannelState[3] = (HAL_TIM_CHANNEL_STATE_RESET); } while(0);
...
HAL_StatusTypeDef HAL_TIM_Base_Start(TIM_HandleTypeDef *htim)
{
  ...
  if ((((htim->Instance) == ((TIM_TypeDef *)((0x40000000UL + 0x00010000UL) + 0x00002C00UL))) || ((htim->Instance) == ((TIM_TypeDef *)(0x40000000UL + 0x00000000UL))) || ((htim->Instance) == ((TIM_TypeDef *)(0x40000000UL + 0x00000400UL))) || ((htim->Instance) == ((TIM_TypeDef *)(0x40000000UL + 0x00000800UL)))))
  {
...
#line 681 "../Drivers/STM32F1xx_HAL_Driver/Src/stm32f1xx_hal_tim.c"
...
#line 728 "../Drivers/STM32F1xx_HAL_Driver/Src/stm32f1xx_hal_tim.c"
...
HAL_StatusTypeDef HAL_TIM_OC_Start(TIM_HandleTypeDef *htim, uint32_t Channel)
{
  ...
  if ((((Channel) == 0x00000000U) ? (htim)->ChannelState[0] : ((Channel) == 0x00000004U) ? (htim)->ChannelState[1] : ((Channel) == 0x00000008U) ? (htim)->ChannelState[2] : (htim)->ChannelState[3]) != HAL_TIM_CHANNEL_STATE_READY)
  {
    return HAL_ERROR;
  }

   
  (((Channel) == 0x00000000U) ? ((htim)->ChannelState[0] = (HAL_TIM_CHANNEL_STATE_BUSY)) : ((Channel) == 0x00000004U) ? ((htim)->ChannelState[1] = (HAL_TIM_CHANNEL_STATE_BUSY)) : ((Channel) == 0x00000008U) ? ((htim)->ChannelState[2] = (HAL_TIM_CHANNEL_STATE_BUSY)) : ((htim)->ChannelState[3] = (HAL_TIM_CHANNEL_STATE_BUSY)));

   
  TIM_CCxChannelCmd(htim->Instance, Channel, 0x00000001U);

  if (((htim->Instance) == ((TIM_TypeDef *)((0x40000000UL + 0x00010000UL) + 0x00002C00UL))) != RESET)
  {
...
HAL_StatusTypeDef HAL_TIM_OC_Stop(TIM_HandleTypeDef *htim, uint32_t Channel)
{
  ...
  (((Channel) == 0x00000000U) ? ((htim)->ChannelState[0] = (HAL_TIM_CHANNEL_STATE_READY)) : ((Channel) == 0x00000004U) ? ((htim)->ChannelState[1] = (HAL_TIM_CHANNEL_STATE_READY)) : ((Channel) == 0x00000008U) ? ((htim)->ChannelState[2] = (HAL_TIM_CHANNEL_STATE_READY)) : ((htim)->ChannelState[3] = (HAL_TIM_CHANNEL_STATE_READY)));
                                       ...
                                       uint16_t Length)
{
  ...
  if ((((Channel) == 0x00000000U) ? (htim)->ChannelState[0] : ((Channel) == 0x00000004U) ? (htim)->ChannelState[1] : ((Channel) == 0x00000008U) ? (htim)->ChannelState[2] : (htim)->ChannelState[3]) == HAL_TIM_CHANNEL_STATE_BUSY)
  {
    return HAL_BUSY;
  }
  else if ((((Channel) == 0x00000000U) ? (htim)->ChannelState[0] : ((Channel) == 0x00000004U) ? (htim)->ChannelState[1] : ((Channel) == 0x00000008U) ? (htim)->ChannelState[2] : (htim)->ChannelState[3]) == HAL_TIM_CHANNEL_STATE_READY)
  {
    if ((pData == 0) || (Length == 0U))
    {
      return HAL_ERROR;
...
#line 1346 "../Drivers/STM32F1xx_HAL_Driver/Src/stm32f1xx_hal_tim.c"
...
#line 1393 "../Drivers/STM32F1xx_HAL_Driver/Src/stm32f1xx_hal_tim.c"
...
#line 2010 "../Drivers/STM32F1xx_HAL_Driver/Src/stm32f1xx_hal_tim.c"
...
#line 2057 "../Drivers/STM32F1xx_HAL_Driver/Src/stm32f1xx_hal_tim.c"
...
{
  uint32_t tmpsmcr;
  HAL_TIM_ChannelStateTypeDef channel_state = (((Channel) == 0x00000000U) ? (htim)->ChannelState[0] : ((Channel) == 0x00000004U) ? (htim)->ChannelState[1] : ((Channel) == 0x00000008U) ? (htim)->ChannelState[2] : (htim)->ChannelState[3]);
...
#line 2660 "../Drivers/STM32F1xx_HAL_Driver/Src/stm32f1xx_hal_tim.c"
...
#line 2715 "../Drivers/STM32F1xx_HAL_Driver/Src/stm32f1xx_hal_tim.c"
...
#line 3063 "../Drivers/STM32F1xx_HAL_Driver/Src/stm32f1xx_hal_tim.c"
...
#line 3151 "../Drivers/STM32F1xx_HAL_Driver/Src/stm32f1xx_hal_tim.c"
...
#line 6309 "../Drivers/STM32F1xx_HAL_Driver/Src/stm32f1xx_hal_tim.c"
...
HAL_TIM_ChannelStateTypeDef HAL_TIM_GetChannelState(const TIM_HandleTypeDef *htim,  uint32_t Channel)
{
  ...
  channel_state = (((Channel) == 0x00000000U) ? (htim)->ChannelState[0] : ((Channel) == 0x00000004U) ? (htim)->ChannelState[1] : ((Channel) == 0x00000008U) ? (htim)->ChannelState[2] : (htim)->ChannelState[3]);
...
void TIM_DMAError(DMA_HandleTypeDef *hdma)
{
  ...
  {
    htim->Channel = HAL_TIM_ACTIVE_CHANNEL_3;
    (((0x00000008U) == 0x00000000U) ? ((htim)->ChannelState[0] = (HAL_TIM_CHANNEL_STATE_READY)) : ((0x00000008U) == 0x00000004U) ? ((htim)->ChannelState[1] = (HAL_TIM_CHANNEL_STATE_READY)) : ((0x00000008U) == 0x00000008U) ? ((htim)->ChannelState[2] = (HAL_TIM_CHANNEL_STATE_READY)) : ((htim)->ChannelState[3] = (HAL_TIM_CHANNEL_STATE_READY)));
  }
  else if (hdma == htim->hdma[((uint16_t) 0x0004)])
  {
    htim->Channel = HAL_TIM_ACTIVE_CHANNEL_4;
    (((0x0000000CU) == 0x00000000U) ? ((htim)->ChannelState[0] = (HAL_TIM_CHANNEL_STATE_READY)) : ((0x0000000CU) == 0x00000004U) ? ((htim)->ChannelState[1] = (HAL_TIM_CHANNEL_STATE_READY)) : ((0x0000000CU) == 0x00000008U) ? ((htim)->ChannelState[2] = (HAL_TIM_CHANNEL_STATE_READY)) : ((htim)->ChannelState[3] = (HAL_TIM_CHANNEL_STATE_READY)));
  }
  else
  {
    htim->State = HAL_TIM_STATE_READY;
...
void TIM_Base_SetConfig(TIM_TypeDef *TIMx, const TIM_Base_InitTypeDef *Structure)
{
  ...
  if ((((TIMx) == ((TIM_TypeDef *)((0x40000000UL + 0x00010000UL) + 0x00002C00UL))) || ((TIMx) == ((TIM_TypeDef *)(0x40000000UL + 0x00000000UL))) || ((TIMx) == ((TIM_TypeDef *)(0x40000000UL + 0x00000400UL))) || ((TIMx) == ((TIM_TypeDef *)(0x40000000UL + 0x00000800UL)))))
  {
  ...
  if (((TIMx) == ((TIM_TypeDef *)((0x40000000UL + 0x00010000UL) + 0x00002C00UL))))
  {
...
static void TIM_OC1_SetConfig(TIM_TypeDef *TIMx, const TIM_OC_InitTypeDef *OC_Config)
{
  ...
  if ((((TIMx) == ((TIM_TypeDef *)((0x40000000UL + 0x00010000UL) + 0x00002C00UL))) && (((0x00000000U) == 0x00000000U) || ((0x00000000U) == 0x00000004U) || ((0x00000000U) == 0x00000008U))))
  {
...
void TIM_OC2_SetConfig(TIM_TypeDef *TIMx, const TIM_OC_InitTypeDef *OC_Config)
{
  ...
  if ((((TIMx) == ((TIM_TypeDef *)((0x40000000UL + 0x00010000UL) + 0x00002C00UL))) && (((0x00000004U) == 0x00000000U) || ((0x00000004U) == 0x00000004U) || ((0x00000004U) == 0x00000008U))))
  {
    ((void)0U);
...
static void TIM_OC3_SetConfig(TIM_TypeDef *TIMx, const TIM_OC_InitTypeDef *OC_Config)
{
  ...
  if ((((TIMx) == ((TIM_TypeDef *)((0x40000000UL + 0x00010000UL) + 0x00002C00UL))) && (((0x00000008U) == 0x00000000U) || ((0x00000008U) == 0x00000004U) || ((0x00000008U) == 0x00000008U))))
  {
    ((void)0U);
                       ...
                       uint32_t TIM_ICFilter)
{
  ...
  if ((((TIMx) == ((TIM_TypeDef *)((0x40000000UL + 0x00010000UL) + 0x00002C00UL))) || ((TIMx) == ((TIM_TypeDef *)(0x40000000UL + 0x00000000UL))) || ((TIMx) == ((TIM_TypeDef *)(0x40000000UL + 0x00000400UL))) || ((TIMx) == ((TIM_TypeDef *)(0x40000000UL + 0x00000800UL)))) != RESET)
  {
    tmpccmr1 &= ~(0x3UL << (0U));
                              ...
                              uint32_t TIM_ICFilter)
{
  ...
  tmpccer &= ~((0x1UL << (9U)));
  tmpccer |= ((TIM_ICPolarity << 8U) & (0x1UL << (9U)));
                              ...
                              uint32_t TIM_ICFilter)
{
  ...
  tmpccer &= ~((0x1UL << (13U)));
  tmpccer |= ((TIM_ICPolarity << 12U) & (0x1UL << (13U)));
...
#line 7607 "../Drivers/STM32F1xx_HAL_Driver/Src/stm32f1xx_hal_tim.c"
