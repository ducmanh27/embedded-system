...
void setScheduler(char **argv, uint8_t arg_num)
{
	...
	WRITE_FLASH((0X800FFFE), atoi(argv[13]));
	
	
	WRITE_FLASH((0X800FC00), atoi(argv[1]));
	WRITE_FLASH((0X800FC02), atoi(argv[2]));
	WRITE_FLASH((0X800FC04), atoi(argv[3]));
	WRITE_FLASH((0X800FC06), atoi(argv[4]));
	
	WRITE_FLASH((0X800FC08), atoi(argv[5]));
	WRITE_FLASH((0X800FC0A), atoi(argv[6]));
	WRITE_FLASH((0X800FC0C), atoi(argv[7]));
	WRITE_FLASH((0X800FC0E), atoi(argv[8]));
	
	WRITE_FLASH((0X800FC10), atoi(argv[9]));
	WRITE_FLASH((0X800FC12), atoi(argv[10]));
	WRITE_FLASH((0X800FC14), atoi(argv[11]));
	WRITE_FLASH((0X800FC16), atoi(argv[12]));
